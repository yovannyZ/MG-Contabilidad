...
Public Class CONSULTA_CXC1
    Dim COD_SUCURSAL, STATUS_SUC As String
    ...
    Sub MOSTRAR_CONSULTA()
        DGW_DET1.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_CXC_PENDIENTES", con)
        ...
        DGW_DET2.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_CXC_CANCELADAS", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@COD_PER", SqlDbType.Char).Value = TXT_COD1.Text
            PROG_01.Parameters.Add("@STATUS_SUC", SqlDbType.Char).Value = STATUS_SUC
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = COD_SUCURSAL
        ...
        DGW_DET3.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_CXC_KARDEX", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@COD_PER", SqlDbType.Char).Value = TXT_COD1.Text
            PROG_01.Parameters.Add("@STATUS_SUC", SqlDbType.Char).Value = STATUS_SUC
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = COD_SUCURSAL
    ...
    Private Sub TXT_DOC_PER1_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles txt_doc_per1.KeyDown
        ...
        End If
    End Sub
    Private Sub CONSULTA_CXC1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Return) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
    Private Sub CONSULTA_CXC1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        KeyPreview = True
    ...
    Sub HISTORIAL()
        ...
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_CXC_KARDEX2", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@COD_PER", SqlDbType.Char).Value = TXT_COD1.Text
            PROG_01.Parameters.Add("@STATUS_SUC", SqlDbType.Char).Value = STATUS_SUC
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = COD_SUCURSAL
