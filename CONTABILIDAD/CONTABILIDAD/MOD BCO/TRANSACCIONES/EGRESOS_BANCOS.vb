...
Public Class EGRESOS_BANCOS
    Private BOTON, COD_DOC, COD_CC, COD_CONTROL, COD_CUENTA, COD_DH_GRAL, ST_DIF As String
    Private COD_D_H, COD_MON_DOC, VAR_PRO, STATUS_PER, STATUS_P, STATUS_CC, COD_MONEDA As String
    Private COD_AUX, COD_COMP, NRO_COMP, COD_MP, COD_SUC0, COD_PROYECTO As String
    ...
    Dim formDetraccion As New frmDetraccion
    Dim StModifica = False
    ...
    Private Sub btn_anular_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_anular.Click
        ...
        If dgw1.Item(14, dgw1.CurrentRow.Index).Value = True Then
            ...
            Exit Sub
        End If
        If dgw1.Item(15, dgw1.CurrentRow.Index).Value = True Then
            MessageBox.Show("El Comprobante esta Contabilizado", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
        If dgw1.Item(21, dgw1.CurrentRow.Index).Value = True Then
            MessageBox.Show("El Comprobante se encuentra confirmado", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        End If
        ...
        If ((respuesta) = 6) Then
            ...
            Else
                ...
                Try
                    Dim comand1 As New SqlCommand("ANULAR_I_BAN_EGRESO", con)
        ...
        ElseIf ((respuesta) = 7) Then
            ...
            Dim ESTADO As String = "FALLO"
            Try
                Dim comand1 As New SqlCommand("DES_ANULAR_I_BAN_EGRESO", con)
                comand1.CommandType = (CommandType.StoredProcedure)
                comand1.Parameters.Add("@COD_BANCO", SqlDbType.VarChar).Value = txt_cod_ban.Text
                comand1.Parameters.Add("@COD_MP", SqlDbType.VarChar).Value = COD_MP
                comand1.Parameters.Add("@NRO_MP", SqlDbType.VarChar).Value = txt_num_mp.Text
    ...
    Private Sub btn_eliminar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_eliminar.Click
        ...
        ElseIf dgw1.Item(16, dgw1.CurrentRow.Index).Value = True Then
            MessageBox.Show("El Comprobante esta Anulado", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ElseIf dgw1.Item(21, dgw1.CurrentRow.Index).Value = True Then
            MessageBox.Show("El Comprobante se encuentra confirmado", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ElseIf (((CInt(MessageBox.Show("Desea eliminar el Comprobante", "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            ...
            Else
                Dim ESTADO As String = "FALLO"
                Try
                    Dim comand1 As New SqlCommand("ELIMINAR_I_BAN_EGRESO", con)
                    comand1.CommandType = (CommandType.StoredProcedure)
                    comand1.Parameters.Add("@COD_BANCO", SqlDbType.VarChar).Value = txt_cod_ban.Text
                    comand1.Parameters.Add("@COD_MP", SqlDbType.VarChar).Value = COD_MP
                    comand1.Parameters.Add("@NRO_MP", SqlDbType.VarChar).Value = txt_num_mp.Text
        ...
        Else
            ...
            Else
                ...
                dgw_mov1.Rows.Add((dgw_mov1.RowCount + 1).ToString("0000"), COD_DOC, txt_nro_doc.Text, txt_cod1.Text, _
                    ...
                    dtp_mp.Value, txt_glosa.Text, txt_cod_cta.Text, "", dtp_mp.Value, COD_CC, COD_CONTROL, COD_PROYECTO, _
                    STATUS_CC, "1", STATUS_P, STATUS_PER, VAR_PRO, "", "", "", "", "", "", "", "", "", "0.00")
                HALLAR_TOTAL()
                LIMPIAR_DETALLES()
                txt_cod1.Focus()
                'End If
    ...
    Sub CARGAR_DATOS()
        ...
        Try
            ...
            Do While rs3.Read
                ...
                dgw_mov1.Rows.Add(rs3.GetValue(0), rs3.GetValue(1), rs3.GetValue(2), rs3.GetValue(3), rs3.GetValue(4), rs3.GetValue(5), rs3.GetValue(6), Math.Round(rs3.GetValue(7), 2), rs3.GetValue(8), rs3.GetValue(9), rs3.GetValue(10), rs3.GetValue(11), rs3.GetValue(12), rs3.GetValue(13), rs3.GetValue(14), rs3.GetValue(15), rs3.GetValue(16), rs3.GetValue(17), rs3.GetValue(18), rs3.GetValue(19), rs3.GetValue(20), rs3.GetValue(21), rs3.GetValue(22), rs3.GetValue(23), rs3.GetValue(24), rs3.GetValue(25), rs3.GetValue(26), list.Item(0), list.Item(1), list.Item(2), list.Item(3), list.Item(4), rs3.GetValue(27), CInt(rs3.GetValue(28)).ToString("00000"))
                dgw_det2.Rows.Add(rs3.GetValue(0), rs3.GetValue(1), rs3.GetValue(2), rs3.GetValue(3), rs3.GetValue(4), rs3.GetValue(5), rs3.GetValue(6), Math.Round(rs3.GetValue(7), 2), rs3.GetValue(8), rs3.GetValue(9), rs3.GetValue(10), rs3.GetValue(11), rs3.GetValue(12), rs3.GetValue(13), rs3.GetValue(14), rs3.GetValue(15), rs3.GetValue(16), rs3.GetValue(17), rs3.GetValue(18), rs3.GetValue(19), rs3.GetValue(20), rs3.GetValue(21), rs3.GetValue(22), rs3.GetValue(23), rs3.GetValue(24), rs3.GetValue(25), rs3.GetValue(26))
            Loop
            con.Close()
        Catch ex As Exception
            con.Close()
    ...
    Sub CARGAR_DETALLES(ByVal FILA0 As Object)
        VAR_PRO = dgw_mov1.Item(23, (FILA0)).Value
        COD_DOC = dgw_mov1.Item(1, (FILA0)).Value
        txt_nro_doc.Text = dgw_mov1.Item(2, (FILA0)).Value
        txt_cod1.Text = dgw_mov1.Item(3, (FILA0)).Value
        txt_desc_per.Text = dgw_mov1.Item(4, (FILA0)).Value
        txt_nro_doc_per.Text = dgw_mov1.Item(5, (FILA0)).Value
        txt_imp_soles.Text = dgw_mov1.Item(6, (FILA0)).Value
        txt_imp_soles.Text = (OBJ.HACER_DECIMAL(txt_imp_soles.Text))
        COD_MON_DOC = dgw_mov1.Item(8, (FILA0)).Value
        txt_glosa.Text = dgw_mov1.Item(12, (FILA0)).Value
        txt_cod_cta.Text = dgw_mov1.Item(13, (FILA0)).Value
        txt_desc_cta.Text = OBJ.DESC_CPTO(txt_cod_cta.Text)
        COD_D_H = dgw_mov1.Item(9, (FILA0)).Value
        COD_CUENTA = dgw_mov1.Item(14, (FILA0)).Value
        COD_CC = dgw_mov1.Item(16, (FILA0)).Value
        COD_CONTROL = dgw_mov1.Item(17, (FILA0)).Value
        COD_PROYECTO = dgw_mov1.Item(18, (FILA0)).Value
        STATUS_CC = dgw_mov1.Item(19, (FILA0)).Value
        STATUS_P = dgw_mov1.Item(21, (FILA0)).Value
    ...
    Sub DATAGRID()
        Try
            Dim pro As New SqlCommand("MOSTRAR_I_BAN_EGRESO", con)
    ...
    Sub INSERTAR_DE_DAILOG()
        ...
        Dim K As Integer = 0
        For K = 0 To CONT
            If OFR.DGW_CAB.Item(9, K).Value = True Then
                ...
                Dim MON_ORIGEN As String = OFR.DGW_CAB.Item(6, K).Value.ToString
                Dim imp_pago As Decimal
                If MON_ORIGEN = COD_MONEDA Then
                    imp_pago = Math.Round(OFR.DGW_CAB.Item(8, K).Value, 2)
                Else
                    If COD_MONEDA = "S" Or COD_MONEDA.ToString = "System.Data.DataRowView" Then
                        imp_pago = OBJ.HACER_DECIMAL(Math.Round(OFR.DGW_CAB.Item(8, K).Value * txt_cambio.Text, 2))
                    Else
                        imp_pago = OBJ.HACER_DECIMAL(Math.Round(OFR.DGW_CAB.Item(8, K).Value / txt_cambio.Text, 2))
                    End If
                End If
                ...
                dgw_mov1.Rows.Add((dgw_mov1.RowCount + 1).ToString("0000"), OFR.DGW_CAB.Item(0, K).Value, OFR.DGW_CAB.Item(2, K).Value, _
                    ...
                    "0", "S", "", "", "", list.Item(0), list.Item(1), list.Item(2), list.Item(3), list.Item(4), _
                    OFR.DGW_CAB.Item(19, K).Value, OFR.DGW_CAB.Item(18, K).Value)
            End If
        Next
        VERIFICAR_DETRACCION()
        VERIFICAR_PERCEPCION()
    End Sub
    Function VERIFICAR_PERCEPCION() As Boolean
        ...
        Do While (I <= CONT)
            Try
                Dim comand As New SqlCommand("VERIFICAR_PERCEPCION", con)
                comand.CommandType = CommandType.StoredProcedure
                comand.Parameters.Add("@COD_PER", SqlDbType.Char).Value = dgw_mov1.Item(3, I).Value.ToString.Trim
                comand.Parameters.Add("@COD_DOC", SqlDbType.Char).Value = dgw_mov1.Item(1, I).Value.ToString.Trim
                comand.Parameters.Add("@NRO_DOC", SqlDbType.Char).Value = dgw_mov1.Item(2, I).Value.ToString.Trim
                comand.Parameters.Add("@NRO_DOC_PER", SqlDbType.Char).Value = dgw_mov1.Item(5, I).Value.ToString.Trim
                comand.Parameters.Add("@COD_CUENTA", SqlDbType.Char).Value = dgw_mov1.Item(14, I).Value.ToString.Trim
                con.Open()
                comand.ExecuteNonQuery()
                Dim Rs3 As SqlDataReader = comand.ExecuteReader
                Do While Rs3.Read
        ...
        MessageBox.Show("El Documento N°: " & vbCrLf & SB.ToString & vbCrLf & "Tiene(n) Percepción", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Question)
        Return False
    End Function
    Function VERIFICAR_DETRACCION() As Boolean
        SB.Remove(0, SB.Length)
        Dim I As Integer = 0
        Dim CONT As Integer = (dgw_mov1.Rows.Count - 1)
        I = 0
        Do While (I <= CONT)
            Try
                Dim comand As New SqlCommand("VERIFICAR_DETRACCION", con)
                comand.CommandType = CommandType.StoredProcedure
                comand.Parameters.Add("@COD_PER", SqlDbType.Char).Value = dgw_mov1.Item(3, I).Value.ToString.Trim
                comand.Parameters.Add("@COD_DOC", SqlDbType.Char).Value = dgw_mov1.Item(1, I).Value.ToString.Trim
                comand.Parameters.Add("@NRO_DOC", SqlDbType.Char).Value = dgw_mov1.Item(2, I).Value.ToString.Trim
        ...
        If (SB.Length = 0) Then
            Return True
        End If
        MessageBox.Show("El Documento N° : " & vbCrLf & SB.ToString & vbCrLf & "Tiene(n) Detracción", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Question)
        Return False
    End Function
    Function INSERTAR_TODO() As String
        ...
        I = 0
        Do While (I <= CONT)
            DT.Rows.Add(COD_MP, txt_num_mp.Text, txt_cod_ban.Text, (I + 1).ToString("0000"), AÑO, MES, dgw_mov1.Item(1, I).Value.ToString, dgw_mov1.Item(2, I).Value.ToString, dgw_mov1.Item(3, I).Value.ToString, dgw_mov1.Item(5, I).Value.ToString, dtp_mp.Value, dgw_mov1.Item(13, I).Value.ToString, dgw_mov1.Item(14, I).Value.ToString, dgw_mov1.Item(12, I).Value.ToString, Decimal.Parse((dgw_mov1.Item(6, I).Value)), dgw_mov1.Item(9, I).Value.ToString, dgw_mov1.Item(8, I).Value.ToString, txt_cambio.Text, Decimal.Parse((dgw_mov1.Item(10, I).Value)), dgw_mov1.Item(16, I).Value.ToString, dgw_mov1.Item(17, I).Value.ToString, dgw_mov1.Item(18, I).Value.ToString, dgw_mov1.Item(23, I).Value.ToString, dtp_mp.Value, Date.Parse(dgw_mov1.Item(15, I).Value), NOMBRE_PC, _
            dgw_mov1.Item(32, I).Value, dgw_mov1.Item(33, I).Value)
            I += 1
        Loop
        Try
            con.Open()
        ...
        If OBJ.DIR_TABLA_DESC("GCO", "TSIST") = "SI" Then
            ...
            End Try
            Try
                Dim comand As New SqlCommand("COI_INSERTAR_T_BAN_EGRESO", CON_GCO)
                comand.CommandType = (CommandType.StoredProcedure)
            ...
            Else
                ...
                Do While (i <= (dgw_ban.RowCount - 1))
                    If (txt_cod_ban.Text.ToLower = dgw_ban.Item(0, i).Value.ToString.ToLower) Then
                        txt_cod_ban.Text = dgw_ban.Item(0, i).Value
                        txt_desc_ban.Text = dgw_ban.Item(1, i).Value
                        COD_MONEDA = dgw_ban.Item(2, i).Value
                        cbo_moneda.Text = OBJ.DESC_MONEDA(COD_MONEDA)
                        COD_AUX = dgw_ban.Item(3, i).Value
                        CBO_COMPROBANTE00()
                        cbo_com.Text = OBJ.HALLAR_COMP_X_BANCO(txt_cod_ban.Text)
                        txt_saldo.Text = (OBJ.HALLAR_SALDO_BANCOS(txt_cod_ban.Text))
                        cbo_mp.Focus()
    ...
    Private Sub EGRESOS_BANCOS_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = True
        End If
    End Sub

    Private Sub EGRESOS_BANCOS_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = False
        End If
    End Sub
    ...
    Private Sub EGRESOS_BANCOS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DT.Columns.Add("NRO_DETRAC")
        DT.Columns.Add("TASA_DETRAC")
        btn_nuevo.Select()
    End Sub
    ...
    Private Sub btn_imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_imprimir.Click
        ...
        For I = 0 To cont
            ...
            '--------------------------------------
            If COD_MONEDA = "S" Then
                'If dgw_mov1.Item(26, I).Value.ToString = "" Then imptt_doc = "0.00" Else imptt_doc = OBJ.HACER_DECIMAL(dgw_mov1.Item(26, I).Value)
            ...
            ElseIf COD_MONEDA = "D" Then
                'If dgw_mov1.Item(26, I).Value.ToString = "" Then imptt_doc = "0.00" Else imptt_doc = OBJ.HACER_DECIMAL(dgw_mov1.Item(26, I).Value * txt_cambio.Text)
                objeto = dgw_mov1.Item(26, I).Value
                If objeto = "" Then
                    imptt_doc = "0.00"
                Else
            ...
            If DH = "D" Then PAGAR = dgw_mov1.Item(7, I).Value Else PAGAR = dgw_mov1.Item(7, I).Value * -1
            Dim COD_REPOR As String
            COD_REPOR = OBJ.DESC_USUARIO_BANCO(OBJ.COD_MP(cbo_mp.Text), txt_num_mp.Text, txt_cod_ban.Text)
            dt.DataTable1.Rows.Add(dgw_mov1.Item(11, I).Value.ToString.Substring(0, 10), dgw_mov1.Item(2, I).Value, dgw_mov1.Item(1, I).Value, dgw_mov1.Item(3, I).Value, dgw_mov1.Item(13, I).Value, dgw_mov1.Item(14, I).Value, dgw_mov1.Item(12, I).Value, COD_MONEDA, dgw_mov1.Item(10, I).Value, imptt_doc, PAGAR, cbo_com.Text, dgw_mov1.Item(24, I).Value, txt_nro_comp.Text, dgw_mov1.Item(25, I).Value, COD_REPOR, dgw_mov1.Item(8, I).Value, "EGRESO", txt_desc_ban.Text, cbo_mp.Text, txt_num_mp.Text)
        Next
        ...
        'repor.PrintOptions.PaperSize = DirectCast(OBJ.TamañoPapel("IMPRESION"), CrystalDecisions.Shared.PaperSize)
    ...
    Private Sub btnDetraccion_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDetraccion.Click
        Dim Pos As Integer = 0
        Try
            Pos = dgw_mov1.CurrentRow.Index
        Catch ex As Exception
            MessageBox.Show("Debe seleccionar una fila", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End Try
        formDetraccion.Limpiar()
        formDetraccion.Importe = dgw_mov1.Item(6, Pos).Value
        If (dgw_mov1.Item(32, Pos).Value <> "" And dgw_mov1.Item(33, Pos).Value <> 0) Then
            formDetraccion.txtValorDetraccion.Text = OBJ.HACER_DECIMAL(dgw_mov1.Item(6, Pos).Value)
            formDetraccion.txtNumeroDetraccion.Text = dgw_mov1.Item(32, Pos).Value
            formDetraccion.txtTasaDetraccion.Text = dgw_mov1.Item(33, Pos).Value
        End If
        formDetraccion.ShowDialog()
       
        'If CDbl(TXT_TB.Text) > 0 Then
        '    If ValorDetraccion <> 0 And PorDetraccion <> 0 Then
        '        formDetraccion.Cero = True
        '        formDetraccion.txtPorDetraccion.Text = OBJ.HACER_DECIMAL(PorDetraccion)
        '        formDetraccion.txtValorDetraccion.Text = OBJ.HACER_DECIMAL(ValorDetraccion)
        '    End If
        '    formDetraccion.Importe = CDbl(TXT_TT.Text)
        '    formDetraccion.ShowDialog()
        '    If formDetraccion.DialogResult = Windows.Forms.DialogResult.OK Then
        '        If CDec(formDetraccion.txtValorDetraccion.Text) <> 0 Then
        '            PorDetraccion = OBJ.HACER_DECIMAL(formDetraccion.txtPorDetraccion.Text)
        '            ValorDetraccion = OBJ.HACER_DECIMAL(Math.Round(CDbl(formDetraccion.txtValorDetraccion.Text)))
        '            txtValorDetraccion.Text = OBJ.HACER_DECIMAL(ValorDetraccion)
        '            txtPorcentajeDetraccion.Text = OBJ.HACER_DECIMAL(PorDetraccion)
        ...
        If formDetraccion.DialogResult = Windows.Forms.DialogResult.OK Then
            ...
            dgw_mov1.Item(6, Pos).Value = OBJ.HACER_DECIMAL(formDetraccion.txtValorDetraccion.Text)
            dgw_mov1.Item(32, Pos).Value = formDetraccion.txtNumeroDetraccion.Text
            dgw_mov1.Item(33, Pos).Value = formDetraccion.txtTasaDetraccion.Text



            Dim MON_ORIGEN As String = dgw_mov1.Item(8, Pos).Value
            Dim imp_pago As Decimal = 0
            If MON_ORIGEN = COD_MONEDA Then
                imp_pago = Math.Round(CDec(dgw_mov1.Item(6, Pos).Value), 2)
            Else
                If COD_MONEDA = "S" Or COD_MONEDA.ToString = "System.Data.DataRowView" Then
                    imp_pago = OBJ.HACER_DECIMAL(Math.Round(CDec(dgw_mov1.Item(6, Pos).Value) * CDec(txt_cambio.Text), 2))
                    dgw_mov1.Item(7, Pos).Value = imp_pago
                Else
                    imp_pago = OBJ.HACER_DECIMAL(Math.Round(CDec(dgw_mov1.Item(6, Pos).Value) / CDec(txt_cambio.Text), 2))
                    dgw_mov1.Item(7, Pos).Value = imp_pago
                End If
