...
Public Class CONSULTA_CTA_X_COBRAR_PER
    Dim obj As New Class1
    Dim INDICE, INDICE2, INDICE3 As Integer
    Private ofr As New Dialog2
    Dim BOTON_CONTA, BOTON_ANA As String
    Dim ST_AUX, ST_COMP, cod_mon, ST_COMP2, COD_COMP2, cod_mon2 As String
    Private DOC_PER02, COD_MES4, COD_MES3, COD_MES2, ST_AUX2, COD_AUX02 As String
    Private NRO_COMP02, ITEM02, COD_ACT, COD_AUX, COD_AUX0, COD_COMP As String
    Private COD_COMP0, NRO_COMP0, COD_COMP02, cod_mon3, SUCURSAL03 As String
    Private COD_CONT, COD_MES, ITEM0, COD_AUX03, COD_COMP03, NRO_COMP03 As String
    Private DOC_PER03, ITEM03, COD_AUX2 As String
    ...
    Sub MOSTRAR_CONSULTA3()
        dgw3.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_COBRAR_X_PERSONA", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub btn_mod23_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mod23.Click
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_COBRAR_CONSULTA_X_PERSONA", con)
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show(("ELIMINAR: " & NRO_DOC00 & " " & dgw3.Item(3, dgw3.CurrentRow.Index).Value), "ESTA SEGURO DE", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            Try
                Dim CMD As New SqlCommand("ELIMINAR_CONSULTA_COBRAR_X_PER", con)
    ...
    Sub HISTORIAL()
        dgw4.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_COBRAR_X_PERSONA_DETALLE", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_COBRAR_CONSULTA_X_PERSONA2", con)
            comand1.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show(("ELIMINAR COMPROBANTE: " & NRO_DOC00 & " " & dgw4.Item(6, dgw4.CurrentRow.Index).Value), "ESTA SEGURO DE", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            Try
                Dim CMD As New SqlCommand("ELIMINAR_CONSULTA_COBRAR_X_PER2", con)
                CMD.CommandType = CommandType.StoredProcedure
                ...
                'CMD.Parameters.Add("@NRO_DOC_PER", SqlDbType.VarChar).Value = dgw4.Item(11, dgw4.CurrentRow.Index).Value
                CMD.Parameters.Add("@COD_CUENTA", SqlDbType.VarChar).Value = txt_cta3.Text
    ...
    Sub INSERTAR()
        Try
            Dim CMD As New SqlCommand("MODIFICAR_COBRAR_CONSULTA_X_PERSONA", con)
            CMD.CommandType = CommandType.StoredProcedure
    ...
    Sub INSERTAR_DETALLES()
        ...
        For I = 0 To CONT
            ...
            Dim CMD As New SqlCommand("MODIFICAR_COBRAR_CONSULTA_X_PERSONA2", con)
            CMD.CommandType = CommandType.StoredProcedure
            ...
            CMD.Parameters.Add("@COD_REF", SqlDbType.Char).Value = dgw4.Item(16, I).Value.ToString
            CMD.Parameters.Add("@NRO_REF", SqlDbType.VarChar).Value = dgw4.Item(17, I).Value.ToString
            CMD.Parameters.Add("@FECHA_DOC", SqlDbType.DateTime).Value = dgw4.Item(13, I).Value.ToString
            CMD.Parameters.Add("@FECHA_VEN", SqlDbType.DateTime).Value = dgw4.Item(14, I).Value.ToString
    ...
    Sub VERIFICAR_IMPORTES()
        'Dim IMP_TOTAL As Decimal = dgw3.Item(6, dgw3.CurrentRow.Index).Value
    ...
    Sub INSERTAR_DE_DAILOG()
        ...
        Do While (i <= num3)
            ...
            If (ofr.DGW_DET.Item(13, i).Value) = True Then
                '    dgw4.Rows.Add((ofr.DGW_DET.Item(0, i).Value), (ofr.DGW_DET.Item(1, i).Value), (ofr.DGW_DET.Item(2, i).Value), (ofr.DGW_DET.Item(3, i).Value), (ofr.DGW_DET.Item(4, i).Value), (ofr.DGW_DET.Item(5, i).Value), (ofr.DGW_DET.Item(6, i).Value), (ofr.DGW_DET.Item(7, i).Value), (ofr.DGW_DET.Item(8, i).Value), (ofr.DGW_DET.Item(9, i).Value), (ofr.DGW_DET.Item(10, i).Value), (ofr.DGW_DET.Item(11, i).Value), (ofr.DGW_DET.Item(12, i).Value), (ofr.DGW_DET.Item(14, i).Value), (ofr.DGW_DET.Item(15, i).Value), (ofr.DGW_DET.Item(16, i).Value), (ofr.DGW_DET.Item(17, i).Value), (ofr.DGW_DET.Item(18, i).Value), (ofr.DGW_DET.Item(19, i).Value), (ofr.DGW_DET.Item(20, i).Value))
    ...
    Sub MOSTRAR_CONSULTA()
        ...
        dgw_mov.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_COBRAR_X_PERSONA_MOV", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub btn_eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_eliminar.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show(("ELIMINAR: " & NRO_DOC00 & " " & dgw_mov.Item(3, dgw_mov.CurrentRow.Index).Value), "ESTA SEGURO DE", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            Try
                Dim CMD As New SqlCommand("ELIMINAR_CONSULTA_COBRAR_X_PER_MOV", con)
                CMD.CommandType = CommandType.StoredProcedure
