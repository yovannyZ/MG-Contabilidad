...
Public Class CONSULTA_ANALISIS_CXC
    ...
    Sub CARGAR_CONCILIADO()
        ...
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_ANALISIS_CONCILIADO_CXC", con)
        ...
        Catch ex As Exception
            ...
            'MsgBox(ex.Message)
        End Try
        Dim DEBES As New Decimal
        Dim DEBED As New Decimal
        Dim HABERS As New Decimal
        Dim HABERD As New Decimal
        Dim I As Integer = 0
    ...
    Sub CARGAR_KARDEX_CONCILIADO()
        dgw_kardex.Rows.Clear()
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_ANALISIS_KARDEX_CONCILIADO_CXC", con)
            pro_02.CommandType = (CommandType.StoredProcedure)
    ...
    Sub CARGAR_KARDEX_NO_CONCILIADO()
        ...
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_ANALISIS_KARDEX_NO_CONCILIADO_CXC", con)
            pro_02.CommandType = (CommandType.StoredProcedure)
            pro_02.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = cbo_año3.Text
            pro_02.Parameters.Add("@COD_PER", SqlDbType.Char).Value = (txt_cod_per0.Text)
    ...
    Sub CARGAR_MAESTROS_CUENTAS()
        ...
        Try
            ...
            pro_02.Parameters.Add("@STATUS_ANA", SqlDbType.VarChar).Value = ("C")
            con.Open()
            pro_02.ExecuteNonQuery()
            Dim rs2 As SqlDataReader = pro_02.ExecuteReader
            Do While rs2.Read
    ...
    '    txt_mov.Clear()
    '    Try
    '        Dim pro_02 As New SqlCommand("MOSTRAR_SALDO_MOV_CXC", con)
    '        pro_02.CommandType = (CommandType.StoredProcedure)
    '        pro_02.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = cbo_año.Text
    '        pro_02.Parameters.Add("@COD_CUENTA", SqlDbType.VarChar).Value = (dgw_cuenta.Item(0, dgw_cuenta.CurrentRow.Index).Value.ToString)
    ...
    Sub CARGAR_PENDIENTE_DEFECTO()
        ...
        prueba()
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_ANALISIS_TCXC", con)
            pro_02.CommandType = (CommandType.StoredProcedure)
            pro_02.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = cbo_año.Text
    ...
    Sub CARGAR_PENDIENTE_DEFECTO_CONCILIADO()
        ...
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_ANALISIS_TCXC2", con)
            pro_02.CommandType = (CommandType.StoredProcedure)
            pro_02.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = cbo_año.Text
    ...
    Private Sub CONSULTA_ANALISIS_CXC_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        main(&H55) = 0
    End Sub
    Private Sub CONSULTA_ANALISIS_CXC_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Sub CARGAR_AÑO()
        ...
        End Try
    End Sub
    Private Sub CONSULTA_ANALISIS_CXC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        KeyPreview = True
        CARGAR_AÑO()
        cbo_año.Text = AÑO
        cbo_año2.Text = AÑO
