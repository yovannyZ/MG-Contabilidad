...
Public Class CONSULTA_ANA_PENDIENT_COBRAR
    Dim obj As New Class1
    Dim INDICE, INDICE2, INDICE3, INDICE4 As Integer
    Dim ST_AUX, ST_COMP, cod_mon, ST_COMP2 As String
    Dim COD_COMP2, cod_mon2, DOC_PER02, COD_MES4 As String
    Dim COD_MES3, COD_MES2, ST_AUX2, COD_AUX02 As String
    Dim NRO_COMP02, ITEM02, COD_ACT, COD_AUX, COD_AUX0 As String
    Dim COD_COMP, COD_COMP0, NRO_COMP0, COD_COMP02 As String
    Dim cod_mon3, cod_mon4, SUCURSAL03, COD_CONT, COD_MES, ITEM0 As String
    Dim COD_AUX03, COD_COMP03, NRO_COMP03, DOC_PER03, ITEM03, COD_AUX2 As String
    ...
    Sub PERSONAS()
        ...
        '-----------------------------------------
        Try
            dgw_per3.DataSource = obj.MOSTRAR_PERSONAS_COBRAR
    ...
    Private Sub btn_cancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_cancelar.Click, btn_salir2.Click, btn_salir3.Click, btn_salir4.Click
        main(32) = 0
        Close()
    End Sub
    ...
    Sub MOSTRAR_CONSULTA()
        dgw1.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_PENDIENTES_COBRAR", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Sub MOSTRAR_CONSULTA2()
        dgw2.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_ANALISIS_COBRAR", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub btn_mod2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_mod2.Click
        ...
        End If
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_TCTAS_COBRAR_CONSULTA", con)
    ...
    Private Sub btn_mod22_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_mod22.Click
        ...
        End If
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_ANALISIS_COBRAR_CONSULTA", con)
            comand1.CommandType = (CommandType.StoredProcedure)
    ...
    Sub MOSTRAR_CONSULTA3()
        dgw3.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_GESTION_COBRAR", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Sub MOSTRAR_CONSULTA4()
        dgw4.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("CONSULTA_PCTAS_COBRAR", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub btn_mod23_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mod23.Click
        ...
        End If
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_GESTION_COBRAR_CONSULTA", con)
            comand1.CommandType = (CommandType.StoredProcedure)
    ...
    Private Sub cbo_año4_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_año4.SelectedIndexChanged
        CARGAR_CUENTA4()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show(("ELIMINAR: " & COD_CLASE & " " & dgw1.Item(3, dgw1.CurrentRow.Index).Value), "ESTA SEGURO DE", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            Try
                Dim CMD As New SqlCommand("ELIMINAR_CONSULTA_PENDIENTES_COBRAR", con)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show(("ELIMINAR: " & COD_CLASE & " " & dgw2.Item(3, dgw2.CurrentRow.Index).Value), "ESTA SEGURO DE", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            Try
                Dim CMD As New SqlCommand("ELIMINAR_CONSULTA_ANALISIS_COBRAR", con)
                CMD.CommandType = CommandType.StoredProcedure
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show(("ELIMINAR: " & COD_CLASE & " " & dgw3.Item(3, dgw3.CurrentRow.Index).Value), "ESTA SEGURO DE", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            Try
                Dim CMD As New SqlCommand("ELIMINAR_CONSULTA_GESTION_COBRAR", con)
                CMD.CommandType = CommandType.StoredProcedure
    ...
    Private Sub txt_cta_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_cta.TextChanged
    ...
    Private Sub BTN_LIMP4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_LIMP4.Click
        txt_cta4.Clear()
        txt_desc_cta4.Clear()
        dgw4.Rows.Clear()
        G4.Enabled = True
    ...
    Private Sub BTN_MOD_PEND_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_MOD_PEND.Click
        Try
    ...
    Private Sub btn_mod24_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mod24.Click
        ...
        End If
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_PCTAS_COBRAR_CONSULTA", con)
            comand1.CommandType = (CommandType.StoredProcedure)
