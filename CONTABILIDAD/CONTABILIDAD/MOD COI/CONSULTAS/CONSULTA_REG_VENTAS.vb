Public Class CONSULTA_REG_VENTAS
    Private COD_AUX As String
    Dim obj As New Class1

#Region "Constructor"
    Private Shared instancia As New CONSULTA_REG_VENTAS
    Public Shared Function ObtenerInstancia() As CONSULTA_REG_VENTAS
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New CONSULTA_REG_VENTAS
        End If
...
#End Region
    ...
    Private Sub btnConsultar(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            If chkNroDocumento.Checked = False Then
                Dim frmConsulta As New CONSULTA_DOCUMENTO_VENTA
    ...
    Private Sub Consultar(ByVal codDoc As String, ByVal codPer As String, ByVal nroDoc As String, ByVal feIni As Date, ByVal feFin As Date)
        ...
        dgw1.Rows.Clear()
        Try
            Dim cmd As New SqlCommand("OBTENER_REGISTRO_VENTAS", con)
    ...
    Private Sub CONSULTA_REG_VENTAS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CargarTipoDoc()
        CargarPersonas()
    End Sub
