...
#Region "Variables"
    ...
    Private LoPle0324 As New List(Of Ple_3_20)
...
#End Region
#Region "Constructor"
    Private Shared instancia As New frm0320
    Public Shared Function ObtenerInstancia() As frm0320
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New frm0320
        End If
...
#Region "Botones"
    ...
    Private Sub btn_exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_exportar.Click
        ...
        If ofbd.ShowDialog = Windows.Forms.DialogResult.OK Then
            Dim Archivo As String = String.Format("LE{0}{1}{2}{3}032000011111.txt", RUC_EMPRESA, cbo_año.Text, obj.COD_MES(cbo_mes.Text), FechaFin.Date.Day)
...
#Region "Metodos"
    ...
    Private Sub ConsultarPle()
        LoPle0324.Clear()
        Using cmd As New SqlCommand("MOSTRAR_PLE_03_20", con)
    ...
    '    'HallarItem()
    '    Using cmd As New SqlCommand("INSERTAR_PLE_03_20", con)
    '        cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub InsertarPle()
        ...
        While (z < CantidadRegistros)
            If ValidarRegistros(Registros.Item(z)(1).ToString, tr).ToString.Length > 0 Then
                ...
                Continue While
            End If
            Using cmd As New SqlCommand("INSERTAR_PLE_03_20", con, tr)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@PERIODO", SqlDbType.Char).Value = txtPeriodo.Text
                cmd.Parameters.Add("@CODIGO_CATALOGO", SqlDbType.Char).Value = CodigoCatalogo
    ...
    Private Sub ActualizarPle()
        Using cmd As New SqlCommand("ACTUALIZAR_PLE_03_20", con)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add("@PERIODO", SqlDbType.Char).Value = txtPeriodo.Text
            cmd.Parameters.Add("@CODIGO_CATALOGO", SqlDbType.Char).Value = CodigoCatalogo
            cmd.Parameters.Add("@CODIGO_RUBRO", SqlDbType.VarChar).Value = txtRubroEstadoFinanciero.Text
    ...
    Private Sub EliminarPle(ByVal Periodo As String, ByVal CodCatalogo As String, ByVal CodRubro As String)
        Using cmd As New SqlCommand("ELIMINAR_PLE_03_20", con)
            cmd.CommandType = CommandType.StoredProcedure
...
#Region "Funciones"
    ...
    Private Function ValidarRegistros(ByVal CodRubro As String, ByVal tr As SqlTransaction) As String
        ...
        Try
            Using cmd As New SqlCommand("VALIDAR_03_20", con, tr)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@PERIODO", SqlDbType.Char).Value = txtPeriodo.Text
