...
Public Class DESCUADRE_CXP
    Dim OBJ As New Class1
    Dim REP As New REP_DESCUADRE_CXP
    ...
    Private Sub DESCUADRE_CXP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        CARGAR_SUCURSAL()
    End Sub
End Class