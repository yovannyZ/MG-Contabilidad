...
Public Class frmPleCuentaCorriente
#Region "Variables"
...
#Region "Constructor"
    Private Shared instancia As New frmPleCuentaCorriente
    Public Shared Function ObtenerInstancia() As frmPleCuentaCorriente
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New frmPleCuentaCorriente
        End If
