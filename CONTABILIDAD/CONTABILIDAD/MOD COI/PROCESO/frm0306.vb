    ...
    Private Sub CargarDatosExcel()
        ...
        Try
            Using cnn As New OleDbConnection(conExcel)
                Using cmd As New OleDbCommand("Select * from [3.6$]", cnn)
        ...
        If chkContinuo.Checked Then
            For Each dr In ds.Tables(0).Rows
                ...
                With OCuentaCorriente
                    ...
                    .CuentaContable = ""
                    .DescCuenta = ""
                    .TipoComprobante = dr(6)
                    .SerieComprobante = dr(7)
                    .NroComprobante = dr(8)
...
#End Region
#Region "Constructor"
    Private Shared instancia As New frm0306
    Public Shared Function ObtenerInstancia() As frm0306
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New frm0306
        End If
