    ...
    Private Sub CargarPlecuentaCorriente()
        Try
            ...
            Using cmd As New SqlCommand("REPORTE_CONCILIADAS_PLE", con)
                ...
                cmd.Parameters.Add("@COD_CUENTA", SqlDbType.Char).Value = "41"
    ...
    Private Sub CargarDatosExcel()
        ...
        Try
            Using cnn As New OleDbConnection(conExcel)
                Using cmd As New OleDbCommand("Select * from [3.11$]", cnn)
        ...
        For Each dr In ds.Tables(0).Rows
            ...
            With OCuentaCorriente
                ...
                .NumeroAsiento = dr(2)
                .TipoDocIdentidad = dr(4)
                .NroDocIdentidad = dr(5)
                .RazonSocial = dr(7)
                .FechaEmision = ""
                .MontoCobrar = dr(8)
...
#Region "Constructor"
    Private Shared instancia As New frmPle0311
    Public Shared Function ObtenerInstancia() As frmPle0311
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New frmPle0311
        End If
