...
Imports System.IO
Public Class frm0307
    Dim FechaInicio, FechaFin As DateTime
    Dim obj As New Class1
#Region "Constructor"
    Private Shared instancia As New frm0307
    Public Shared Function ObtenerInstancia() As frm0307
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New frm0307
        End If
...
#End Region
    ...
    Private Sub btn_exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_exportar.Click
        ...
        If ofbd.ShowDialog = Windows.Forms.DialogResult.OK Then
            Dim Archivo As String = String.Format("LE{0}{1}{2}{3}030700011011.txt", RUC_EMPRESA, cbo_año.Text, obj.COD_MES(cbo_mes.Text), FechaFin.Date.Day)
