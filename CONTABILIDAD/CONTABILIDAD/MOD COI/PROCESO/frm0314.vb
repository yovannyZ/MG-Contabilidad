...
Imports System.IO
Public Class frm0314
    Dim FechaInicio, FechaFin As DateTime
    Dim obj As New Class1
#Region "Constructor"
    Private Shared instancia As New frm0314
    Public Shared Function ObtenerInstancia() As frm0314
        If instancia Is Nothing OrElse instancia.IsDisposed Then
            instancia = New frm0314
        End If
...
#End Region
    ...
    Private Sub btn_exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_exportar.Click
        ...
        If ofbd.ShowDialog = Windows.Forms.DialogResult.OK Then
            Dim Archivo As String = String.Format("LE{0}{1}{2}{3}031400011011.txt", RUC_EMPRESA, cbo_año.Text, obj.COD_MES(cbo_mes.Text), FechaFin.Date.Day)
