...
Public Class GCO_CXC_CANC
    ...
    Private FECHA_PLA As New DateTime
        ...
        Else
            ...
            Do While (I <= CONT0)
                If DGW1.Item(8, I).Value.ToString = "True" Then
                    ...
                    '    Exit Sub
                    'End If
                    Dim k1 As String = cbo_com.Text
                    cbo_com.SelectedIndex = -1
                    cbo_com.Text = k1
                    COD_SUCURSAL = (DGW1.Item(0, I).Value)
                    COD_PER = DGW1.Item(2, I).Value.ToString
                    DESC_PER = DGW1.Item(3, I).Value.ToString
                    DOC_PER = DGW1.Item(4, I).Value.ToString
            ...
            For I = 0 To CONT
                If DGW_CANC.Item(8, I).Value.ToString = "True" Then
                    ...
                    Else
                        ...
                        COD_PER = DGW_CANC.Item(2, I).Value.ToString
                        DESC_PER = DGW_CANC.Item(3, I).Value.ToString
                        DOC_PER = DGW_CANC.Item(4, I).Value.ToString
    ...
    Private Sub btn_buscar0_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_buscar0.Click
        ...
        txt_letra0.Focus()
        Dim CONT0 As Integer = (DGW_CANC.RowCount - 1)
        Dim i As Integer = 0
        Do While (i <= CONT0)
            Dim CONT As Integer = Strings.Len(DGW_CANC.Item(7, i).Value.ToString)
            Dim f As Integer = 1
            Do While (f <= CONT)
    ...
    Private Sub btn_buscar1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_buscar1.Click
        ...
        Dim i As Integer = 0
        Do While (i <= CONT0)
            Dim CONT As Integer = Strings.Len(DGW1.Item(7, i).Value.ToString)
            Dim f As Integer = 1
            Do While (f <= CONT)
    ...
    Private Sub btn_buscar2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_buscar2.Click
        ...
        Dim i As Integer = 0
        Do While (i <= CONT0)
            Dim CONT As Integer = Strings.Len(DGW2.Item(7, i).Value.ToString)
            Dim f As Integer = 1
            Do While (f <= CONT)
    ...
    Public Sub CARGAR_CERRADAS()
        Try
            Dim CMD As New SqlCommand("COI_MOSTRAR_I_CXC_CANJE_COI2", CON_GCO)
            ...
            DGW2.Columns.Item(4).Visible = False
            DGW2.Columns.Item(5).Visible = False
            DGW2.Columns.Item(6).Visible = False
    ...
    Public Sub CARGAR_DOC_PLANILLA(ByVal COD_SUC0 As Object, ByVal NRO_PLA0 As Object)
        Try
            Dim PRO_02 As New SqlCommand("COI_MOSTRAR_TCXC_CANJE", CON_GCO)
            ...
            Do While RS3.Read
                If (RS3.GetString(0) = "30") Then
                    VEN0 = Date.Parse(RS3.GetValue(9))
                    FECHA0 = Date.Parse(RS3.GetValue(3))
                    dgw_det.Rows.Add((RS3.GetValue(0)), RS3.GetValue(1), RS3.GetValue(2), RS3.GetValue(3), RS3.GetValue(4), RS3.GetValue(5), RS3.GetValue(6), RS3.GetValue(7), RS3.GetValue(8), RS3.GetValue(9), "L")
                    COD_MONEDA = RS3.GetValue(10)
                Else
                    dgw_det.Rows.Add(New Object() {(RS3.GetValue(0)), RS3.GetValue(1), RS3.GetValue(2), RS3.GetValue(3), RS3.GetValue(4), RS3.GetValue(5), RS3.GetValue(6), RS3.GetValue(7), RS3.GetValue(8), RS3.GetValue(9), RS3.GetValue(10)})
                End If
            Loop
            CON_GCO.Close()
        Catch ex As Exception
        ...
        I = 0
        Do While (I <= CONT0)
            ORIGEN0 = obj.BUSCAR_CUENTA_PCXC(Integer.Parse(COD_SUCURSAL).ToString("00"), COD_PER, dgw_det.Item(0, I).Value.ToString, dgw_det.Item(2, I).Value.ToString)
            I += 1
        Loop
    End Sub
    ...
    Public Function CARGAR_DOC_PLANILLA0(ByVal COD_SUC0 As Object, ByVal NRO_PLA0 As Object) As String
        ...
        Try
            Dim PRO_02 As New SqlCommand("COI_MOSTRAR_TCXC_CANC_PTE", CON_GCO)
            PRO_02.CommandType = CommandType.StoredProcedure
            PRO_02.Parameters.Add("@COD_SUCURSAL", SqlDbType.VarChar).Value = COD_SUCURSAL
            PRO_02.Parameters.Add("@NRO_PLANILLA", SqlDbType.VarChar).Value = NRO_PLANILLA
            PRO_02.Parameters.Add("@FE_AÑO", SqlDbType.VarChar).Value = AÑO
            ...
            Dim RS3 As SqlDataReader = PRO_02.ExecuteReader
            Do While RS3.Read
                dgw_mov1.Rows.Add((dgw_mov1.RowCount + 1).ToString("0000"), (RS3.GetValue(0)), RS3.GetValue(1), RS3.GetValue(2), RS3.GetValue(3), RS3.GetValue(4), RS3.GetValue(5), RS3.GetValue(6), RS3.GetValue(7), RS3.GetValue(8), RS3.GetValue(9), RS3.GetValue(10), (RS3.GetValue(11)), (RS3.GetValue(12)), (RS3.GetValue(13)), "", "", "", "", "", "", "", "S", (RS3.GetValue(14)), (RS3.GetValue(15)))
            Loop
            CON_GCO.Close()
        Catch ex As Exception
        ...
        Do While (I <= CONT)
            ...
            COD_MP = dgw_mov1.Item(23, I).Value.ToString
            NRO_MP = dgw_mov1.Item(24, I).Value.ToString
            dgw_mov1.Item(13, I).Value = obj.BUSCAR_CUENTA_PCXC(Integer.Parse(COD_SUCURSAL).ToString("00"), dgw_mov1.Item(3, I).Value.ToString, dgw_mov1.Item(1, I).Value.ToString, dgw_mov1.Item(2, I).Value.ToString)
            If obj.BUSCAR_IMP_PCXC(Integer.Parse(COD_SUCURSAL).ToString("00"), dgw_mov1.Item(3, I).Value.ToString, dgw_mov1.Item(1, I).Value.ToString, dgw_mov1.Item(2, I).Value.ToString, dgw_mov1.Item(13, I).Value.ToString) < dgw_mov1.Item(6, I).Value Then
                Return (dgw_mov1.Item(3, I).Value.ToString & " " & dgw_mov1.Item(2, I).Value.ToString)
            End If
            dgw_canc2.Rows.Add(New Object() {COD_MP, cod_doc22, (dgw_mov1.Item(2, I).Value), dtp_com0.Value, (dgw_mov1.Item(3, I).Value), (dgw_mov1.Item(4, I).Value), (dgw_mov1.Item(5, I).Value), (dgw_mov1.Item(9, I).Value), (dgw_mov1.Item(6, I).Value), (dgw_mov1.Item(8, I).Value), TIPO_CAMBIO, (dgw_mov1.Item(12, I).Value), (dgw_mov1.Item(13, I).Value), (dgw_mov1.Item(15, I).Value), (dgw_mov1.Item(16, I).Value), (dgw_mov1.Item(17, I).Value), "", (dgw_mov1.Item(14, I).Value), (dgw_mov1.Item(18, I).Value), (dgw_mov1.Item(19, I).Value), (dgw_mov1.Item(20, I).Value), (dgw_mov1.Item(22, I).Value), "", NRO_MP, dtp_com0.Value, 1, COD_MP, NRO_MP, "0"})
            I += 1
        Loop
        dgw_canc2.Rows.Add(New Object() {COD_MP, "00", NRO_PLANILLA, dtp_com0.Value, "", "", "", "D", IMP_TOTAL, COD_MONEDA, TIPO_CAMBIO, "CANCELACIÓN DE DOCUMENTOS", COD_CUENTA, " ", " ", " ", "0", dtp_com0.Value, "", "", "", "", "", "", dtp_com0.Value, 1, "", NRO_PLANILLA, "1"})
        Return ""
    End Function

    Public Sub CARGAR_PENDIENTES()
        Try
            Dim CMD As New SqlCommand("COI_MOSTRAR_I_CXC_CANJE_PTE_COI", CON_GCO)
            CMD.CommandType = CommandType.StoredProcedure
            CMD.Parameters.Add("@TIPO_USU", SqlDbType.Char).Value = TIPO_USU
            CMD.Parameters.Add("@COD_USU", SqlDbType.Char).Value = COD_USU
            CMD.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
    ...
    Public Sub CARGAR_PENDIENTES0()
        ...
        End Try
        Try
            Dim CMD As New SqlCommand("COI_MOSTRAR_I_CXC_CANC_PTE_COI", CON_GCO)
            CMD.CommandType = CommandType.StoredProcedure
            CMD.Parameters.Add("@TIPO_USU", SqlDbType.Char).Value = TIPO_USU
            CMD.Parameters.Add("@COD_USU", SqlDbType.Char).Value = COD_USU
            CMD.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
            ...
            DGW_CANC.Columns.Item(2).Visible = False
            DGW_CANC.Columns.Item(3).Visible = False
            DGW_CANC.Columns.Item(4).Visible = False
            ...
            DGW_CANC.Columns.Item(14).DefaultCellStyle.Alignment = DataGridViewContentAlignment.BottomRight
            DGW_CANC.Columns.Item(14).DefaultCellStyle.Format = "N4"
    ...
    Public Sub DOC_STATUS()
        Try
            Dim pro_02 As New SqlCommand("COI_I_CXC_STATUS", CON_GCO)
            pro_02.CommandType = CommandType.StoredProcedure
            pro_02.Parameters.Add("@cod_SUCURSAL", SqlDbType.VarChar).Value = COD_SUCURSAL
            pro_02.Parameters.Add("@NRO_PLANILLA", SqlDbType.VarChar).Value = NRO_PLANILLA
            pro_02.Parameters.Add("@FE_AÑO", SqlDbType.VarChar).Value = AÑO
    ...
    Public Function INSERTAR_TODO() As String
        ...
        I = 0
        Do While (I <= CONT0)
            Dim sol As Decimal = Decimal.Parse(dgw_det.Item(6, I).Value)
            Dim dolar As Decimal = Decimal.Divide(sol, Decimal.Parse((TIPO_CAMBIO)))
            If (COD_MONEDA <> "S") Then
                dolar = Math.Round(dgw_det.Item(6, I).Value, 2)
                sol = Math.Round(Decimal.Multiply(dolar, Decimal.Parse((TIPO_CAMBIO))), 2)
            End If
            '----------------------------------------------------------
            ...
            End If
            '----------------------------------------------------------
            DT_DET.Rows.Add(AÑO, MES, COD_AUX, COD_COMP, txt_nro_comp.Text, (dgw_det.Item(0, I).Value), (dgw_det.Item(2, I).Value), COD_PER, DOC_PER, (I + 1).ToString("0000"), DateTime.Parse((dgw_det.Item(3, I).Value)), "", "", dtp_com.Value, "CANJE DE LETRAS", ORIGEN0, sol, dolar, (dgw_det.Item(8, I).Value), COD_MONEDA, TIPO_CAMBIO, "", "", "", "", DateTime.Parse((dgw_det.Item(9, I).Value)), "0", "", "", "0", "", "", "", "", "", dtp_com.Value, 0, "", dgw_det.Item(10, I).Value.ToString, dtp_com.Value, 0, NOMBRE_PC)
            I += 1
        Loop
        ''------------------------------------------------------------------------------------------
        ' REGISTRO DE AJUSTE
        ...
        Try
            ...
            CMD.Parameters.Add("@COD_CUENTA_CANJE", SqlDbType.VarChar).Value = ORIGEN0
            CMD.Parameters.Add("@NRO_LETRAS_CANJE", SqlDbType.VarChar).Value = Integer.Parse(NRO_CUOTA).ToString("00")
            con.Open()
    ...
    Public Function INSERTAR_TODO0() As String
        ...
        Do While (I <= CONT0)
            ...
            End If
            '----------------------------------------------------------
            If (dgw_canc2.Item(28, I).Value.ToString = "1") Then
                VAR_PRO00 = "0"
            Else
                VAR_PRO00 = dgw_canc2.Item(21, I).Value.ToString
            End If
            DT_DET.Rows.Add(AÑO, MES, COD_AUX0, COD_COMP0, txt_nro_comp0.Text, (dgw_canc2.Item(1, I).Value), (dgw_canc2.Item(2, I).Value), (dgw_canc2.Item(4, I).Value), (dgw_canc2.Item(6, I).Value), (I + 1).ToString("0000"), (dgw_canc2.Item(3, I).Value), (dgw_canc2.Item(22, I).Value), (dgw_canc2.Item(23, I).Value), (dgw_canc2.Item(24, I).Value), (dgw_canc2.Item(11, I).Value), (dgw_canc2.Item(12, I).Value), SOLES, DOLARES, (dgw_canc2.Item(7, I).Value), (dgw_canc2.Item(9, I).Value), (dgw_canc2.Item(10, I).Value), (dgw_canc2.Item(13, I).Value), (dgw_canc2.Item(14, I).Value), (dgw_canc2.Item(15, I).Value), " ", (dgw_canc2.Item(17, I).Value), "0", "", "", "0", VAR_PRO00, "0", dgw_canc2.Item(28, I).Value.ToString, (dgw_canc2.Item(0, I).Value), dgw_canc2.Item(27, I).Value.ToString, (dgw_canc2.Item(3, I).Value), (dgw_canc2.Item(25, I).Value), "", VAR_PRO00, dtp_com0.Value, 0, NOMBRE_PC)
            I += 1
        Loop
        '------------------------------------------------------------------------------------------
        ' REGISTRO DE AJUSTE
        ...
        Catch ex As Exception
            ...
            con.Close()
            MsgBox(ex.Message)
            INSERTAR_TODO0 = estado

            Return INSERTAR_TODO0
    ...
    Public Function REGRESAR_I_FACT(ByVal FILA As Integer) As Object
        ...
        Try
            Dim pro_02 As New SqlCommand("COI_I_CXC_STATUS2", CON_GCO)
            pro_02.CommandType = CommandType.StoredProcedure
            pro_02.Parameters.Add("@cod_SUCURSAL", SqlDbType.VarChar).Value = COD_SUCURSAL
            pro_02.Parameters.Add("@NRO_PLANILLA", SqlDbType.VarChar).Value = NRO_PLANILLA
            pro_02.Parameters.Add("@FE_AÑO", SqlDbType.VarChar).Value = AÑO
    ...
    Public Function VERIFICAR_CANC() As Boolean
        Dim I As Integer = 0
        Dim CONT As Integer = (dgw_canc2.RowCount - 1)
        Dim CONT0 As Integer = CONT
        I = 0
