...
Public Class frmConsultaCuentasCobrarRetenciones

    Public CodigoSucursal, CodigoPersona As String
    Public Importe0, Importe1, Importe2 As Decimal
    ...
    Sub CARGAR_PCTAS_PAGAR_PERSONA()
        ...
        Try
            ...
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = CodigoSucursal
            PROG_01.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
            PROG_01.Parameters.Add("@FE_MES", SqlDbType.Char).Value = MES
            PROG_01.Parameters.Add("@COD_PER", SqlDbType.Char).Value = CodigoPersona
            PROG_01.Parameters.Add("@STATUS_PER", SqlDbType.Char).Value = ("0")
            con.Open()
            PROG_01.ExecuteNonQuery()
            Dim Rs3 As SqlDataReader = PROG_01.ExecuteReader
            Do While Rs3.Read
                DGW_CAB.Rows.Add(Rs3.GetValue(0), Rs3.GetValue(1), Rs3.GetValue(2), Rs3.GetValue(3), Rs3.GetValue(4), Rs3.GetValue(5), _
                    Rs3.GetValue(6), Rs3.GetValue(7), Rs3.GetValue(8), Rs3.GetValue(10), Rs3.GetValue(11), Rs3.GetValue(12), _
                    Rs3.GetValue(13), Rs3.GetValue(14), Rs3.GetValue(15), Rs3.GetValue(16), Rs3.GetValue(17), Rs3.GetValue(8))
            Loop
            con.Close()
    ...
    Private Sub Aceptar(ByVal sender As Object, ByVal e As EventArgs) Handles btnAceptar.Click
        Importe1 = DGW_CAB.Item(8, DGW_CAB.CurrentRow.Index).Value.ToString
        Importe2 = DGW_CAB.Item(17, DGW_CAB.CurrentRow.Index).Value.ToString
    ...
    Public Function VERIFICAR(ByVal codigoPersona As Object, ByVal codigoDocumento As Object, ByVal numeroDocumento As Object) As Boolean
        Dim I As Integer = 0
        Dim CONT As Integer = (DGW.Rows.Count - 1)
        I = 0
        Do While (I <= CONT)
            If codigoPersona = DGW.Item(0, I).Value.ToString AndAlso codigoDocumento = DGW.Item(1, I).Value.ToString _
                AndAlso numeroDocumento = DGW.Item(2, I).Value.ToString Then Return False
            I += 1
        Loop
        Return True
    End Function
    ...
    Private Sub frmConsultaCuentasCobrarRetenciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
