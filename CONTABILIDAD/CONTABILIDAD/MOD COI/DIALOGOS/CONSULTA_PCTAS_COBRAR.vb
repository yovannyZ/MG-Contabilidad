...
Public Class CONSULTA_PCTAS_COBRAR
    Public COD_AUX00, COD_COMP00, NRO_COMP00, COD_CPTO00, COD_CTA00, NRO_COMP01 As String
    Public COD_PER00 As String
    Public COD_SUC, MON00 As String
    ...
    Sub CARGAR_PCTAS_PAGAR()
        ...
        End Try
    End Sub
    Sub CARGAR_PCTAS_COBRAR_CUENTA()
        DGW_CAB.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("MOSTRAR_CONSULTA_PCTAS_COBRAR_PTES_CTA", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
            PROG_01.Parameters.Add("@FE_MES", SqlDbType.Char).Value = MES
    ...
    Sub CARGAR_PCTAS_PAGAR_RANGO_DOC()
        DGW_CAB.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("MOSTRAR_CONSULTA_PCTAS_COBRAR_PTES_RANGO", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = (COD_SUC)
            PROG_01.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
        ...
        End Try
    End Sub
    Sub CARGAR_PCTAS_COBRAR_PERSONA_MONEDA()
        DGW_CAB.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("MOSTRAR_CONSULTA_PCTAS_COBRAR_PTES_MONEDA", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = (COD_SUC)
            PROG_01.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
            PROG_01.Parameters.Add("@FE_MES", SqlDbType.Char).Value = MES
        ...
        End Try
    End Sub
    Sub CARGAR_PCTAS_COBRAR_X_COMPROBANTE()
        DGW_CAB.Rows.Clear()
        Try
            Dim PROG_01 As New SqlCommand("MOSTRAR_CONSULTA_PCTAS_COBRAR_PTES2", con)
            PROG_01.CommandType = (CommandType.StoredProcedure)
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = (COD_SUC)
            PROG_01.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
            PROG_01.Parameters.Add("@FE_MES", SqlDbType.Char).Value = MES
    ...
    Private Sub txt_letra_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txt_letra.TextChanged
        ...
        End If
    End Sub
    Public Function VERIFICAR(ByVal COD_PER, ByVal COD_DOC, ByVal NRO_DOC) As Boolean
        ...
        Return True
    End Function
    Private Sub CONSULTA_PCTAS_COBRAR_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
