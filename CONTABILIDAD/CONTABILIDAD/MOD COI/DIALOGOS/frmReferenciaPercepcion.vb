...
Public Class frmReferenciaPercepcion
    Private año0, mes0, cod_mon0, CodigoReferencia As String
    Private MontoPercepcion As Decimal
    Private OBJ As New Class1
    Public CodigoPersona, CodigoSucursal As String
    Public FECHA0 As DateTime
    Public TC, IMPORTE00 As Decimal
    Public EsPerceptor As Boolean
    Public frmCodigoDocumento As String
    ...
    Private Sub frmReferenciaPercepcion_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Return) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmReferenciaPercepcion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CBO_TIPO_DOC00()
    ...
    Sub HALLAR_DATOS_REF(ByVal COD_DOC0 As Object, ByVal NRO_DOC0 As Object, ByVal COD_PER0 As Object, ByVal CUENTA0 As Object, ByVal SUC0 As String)
        ...
        cod_mon0 = ""
        Try
            Dim PROG_01 As New SqlCommand("BUSCAR_DATOS_CXC", con)
        ...
        Try
            ...
            If cod_mon0 = "S" Then
                ...
                txt_ret.Text = Math.Round(Decimal.Parse(txt_conv.Text * MontoPercepcion / 100), 2)

            Else
                txt_conv.Text = Math.Round(Decimal.Parse(txt_ini.Text * TC), 2)
                Dim porcentaje As Decimal
                porcentaje = OBJ.HACER_DECIMAL(txt_ini.Text * MontoPercepcion / 100)
    ...
    Sub CARGAR_DOC_REF(ByVal SUC0 As String, ByVal COD_PER0 As Object, ByVal COD_DOC0 As Object, _
        ...
        txt_ini.Text = "0.00"
        cod_mon0 = ""
        Dim fechaInicio As Date = New Date(FECHA00.AddMonths(-6).Year, FECHA00.AddMonths(-6).Month, 1)
        Try
            Dim PROG_01 As New SqlCommand("MOSTRAR_REFERENCIA_RET_CXC", con)
            PROG_01.CommandType = CommandType.StoredProcedure
            PROG_01.Parameters.Add("@COD_SUCURSAL", SqlDbType.Char).Value = SUC0
            PROG_01.Parameters.Add("@CodigoPersona", SqlDbType.Char).Value = COD_PER0
            PROG_01.Parameters.Add("@COD_DOC", SqlDbType.VarChar).Value = COD_DOC0
    ...
    Private Sub btn_fec_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_fec.Click
        ...
        CodigoReferencia = frmCodigoDocumento 'OBJ.COD_DOC(cbo_tipo_ref.Text)
        HALLAR_DATOS_REF(CodigoReferencia, txt_nro_ref.Text, CodigoPersona, "", CodigoSucursal)
        ...
        If txt_ini.Text <> " " Then
            If cbo_tipo_ref.SelectedIndex <> -1 Then
                ...
                If cbo_tipo_ref.Enabled Then
                    CARGAR_DOC_REF(CodigoSucursal, CodigoPersona, CodigoReferencia, FECHA0)
                    'HALLAR_DATOS_REF(CodigoReferencia, txt_nro_ref.Text, CodigoPersona, "", CodigoSucursal)
                    cbo_tipo_ref.Focus()
                    'Else
                    '    LIMPIAR2()
    ...
    Sub HALLAR_TOTAL2()
        ...
        End If
        If cod_mon0 = "S" Then
            txt_doc_total2.Text = OBJ.HACER_DECIMAL(txt_doc_total.Text * MontoPercepcion / 100)
        Else
            Dim porcentaje As Decimal
            'porcentaje =0.00
            If txt_doc_total.Text <> " " Then
                porcentaje = OBJ.HACER_DECIMAL(txt_doc_total.Text * MontoPercepcion / 100)
    ...
    Private Sub btn_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_guardar.Click
        ...
        CodigoReferencia = OBJ.COD_DOC(cbo_tipo_ref.Text)
        Dim COD_DH As String
        If CodigoReferencia = "07" Then
            COD_DH = "H"
        Else
            COD_DH = "D"
        End If
        ...
        For i = 0 To DGW_CAB.RowCount - 1
            If DGW_CAB.Item(0, i).Value = CodigoReferencia AndAlso DGW_CAB.Item(1, i).Value = txt_nro_ref.Text Then
                existe = True
        ...
        Next
        If Not existe Then
            DGW_CAB.Rows.Add(CodigoReferencia, txt_nro_ref.Text, dtp_ref.Value.Date, cod_mon0, txt_ini.Text, txt_conv.Text, txt_ret.Text, COD_DH, TXT_INI_2DO.Text, TXT_PDTE.Text)
            HALLAR_TOTAL()
            LIMPIAR2()
            cbo_tipo_ref.Focus()
        End If
