Public Class CONSULTA_DOCUMENTO_VENTA
    ...
    Private Sub Consultar()
        ...
        dgw1.Rows.Clear()
        Try
            Dim cmd As New SqlCommand("OBTENER_DOCUMENTOS_VENTA", con)
    ...
    Private Sub CONSULTA_DOCUMENTO_PAGAR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Consultar()
    End Sub
