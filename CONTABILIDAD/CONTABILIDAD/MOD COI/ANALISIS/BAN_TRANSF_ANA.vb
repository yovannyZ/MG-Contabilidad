    ...
    Private Sub btn_aceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_aceptar.Click
        ...
        Do While (j <= k)
            ...
            If dgw1.Item(2, j).Value.ToString = "True" Then
                If OBJ.VERIFICAR_CIERRE_CUENTAS(dgw1.Item(0, j).Value, AÑO, OBJ.COD_MES(cbo_mes.Text)) = False Then Exit Sub
                ...
                If (estado = "FALLO") Then
                    MessageBox.Show((String.Concat("Al tranferir la cuenta: ", dgw1.Item(0, j).Value)), "Ocurrió un error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                    Return
                End If
            End If
            j += 1
