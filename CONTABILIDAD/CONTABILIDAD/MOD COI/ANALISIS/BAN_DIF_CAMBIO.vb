...
Public Class BAN_DIF_CAMBIO
    Dim COD_AUX, cuenta_debe, CUENTA_ENLACE, CUENTA_DESTINO, COD_SUCURSAL2, TOTAL0, DH0, CTA0, TOTAL0_PTE, DH0_PTE, CTA0_PTE, COD_AUX2, COD_COMP, COD_COMP2, COD_CUENTA, COD_SUCURSAL, cuenta_haber As String
    ...
    Private Sub btn_aceptar2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_aceptar2.Click
        ...
        ElseIf (txt_nro_comp2.Text.Trim = "") Then
            MessageBox.Show("Debe insertar el Nº de Comprobante", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            txt_nro_comp2.Focus()
        ElseIf (VERIFICAR_MSALDO_CUENTA) Then
    ...
    Function CREAR_ASIENTO() As String
        ...
        Do While (I <= CONT)
            If dgw1.Item(2, I).Value.ToString = "True" Then
                ...
                Dim IMP_S As Decimal = Decimal.Parse((dgw1.Item(3, I).Value))
                If (Decimal.Compare(IMP_S, Decimal.Zero) < 0) Then
                    COD_D_H0 = "H"
                    IMP_S = Decimal.Multiply(IMP_S, Decimal.MinusOne)
                End If
                DT_DET.Rows.Add(AÑO, MES, COD_AUX, COD_COMP, txt_nro_comp.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE DE DIFERENCIA DE CAMBIO", dgw1.Item(0, I).Value.ToString, IMP_S, 0, COD_D_H0, "A", 1, "", "", "", "", FECHA_GRAL.Date, "0", "", "", "0", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "1")
            End If
            I += 1
        Loop
        'CUENTA DEL TOTAL DEL COMPROBANTE
        '------------------------------------------------
        DT_DET.Rows.Add(AÑO, MES, COD_AUX, COD_COMP, txt_nro_comp.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE TOTAL DE DIFERENCIA DE CAMBIO", CTA0, TOTAL0, 0, DH0, "A", TC_ACT, "", "", "", "", FECHA_GRAL.Date, "0", CUENTA_ENLACE, CUENTA_DESTINO, "0", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "0")
        '------------------------------------------------
        If CUENTA_DESTINO <> "" And CUENTA_ENLACE <> "" Then
            ...
            DT_DET.Rows.Add(AÑO, MES, COD_AUX, COD_COMP, txt_nro_comp.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE TOTAL DE DIFERENCIA DE CAMBIO", CUENTA_ENLACE, TOTAL0, 0, DH_ENLACE, "A", TC_ACT, "", "", "", "", FECHA_GRAL.Date, "0", "", "", "1", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "0")
            DT_DET.Rows.Add(AÑO, MES, COD_AUX, COD_COMP, txt_nro_comp.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE TOTAL DE DIFERENCIA DE CAMBIO", CUENTA_DESTINO, TOTAL0, 0, DH0, "A", TC_ACT, "", "", "", "", FECHA_GRAL.Date, "0", "", "", "1", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "0")
        End If
        Try
            con.Open()
        ...
        End Try
        Try
            Dim CMD As New SqlCommand("INSERTAR_I_CON_DIF_CAMBIO_BAN", con)
            ...
            CMD.Parameters.Add("@fecha_comP", SqlDbType.DateTime).Value = (FECHA_GRAL.Date)
    ...
    Function CREAR_ASIENTO_PTE() As String
        ...
        Do While (I <= CONT)
            If dgw2.Item(2, I).Value.ToString = "True" Then
                ...
                If (Decimal.Compare(IMP_S, Decimal.Zero) < 0) Then
                    ...
                    IMP_S = Decimal.Multiply(IMP_S, Decimal.MinusOne)
                End If
                DT_DET.Rows.Add(AÑO, MES, COD_AUX2, COD_COMP2, txt_nro_comp2.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE DE DIFERENCIA DE CAMBIO", dgw2.Item(0, I).Value.ToString, IMP_S, 0, COD_D_H0, "A", 1, "", "", "", "", FECHA_GRAL.Date, "0", "", "", "0", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "1")
            End If
            I += 1
        Loop
        'CUENTA DEL TOTAL DEL COMPROBANTE
        '------------------------------------------------
        DT_DET.Rows.Add(AÑO, MES, COD_AUX2, COD_COMP2, txt_nro_comp2.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE TOTAL DE DIFERENCIA DE CAMBIO", CTA0_PTE, TOTAL0_PTE, 0, DH0_PTE, "A", TC_ACT, "", "", "", "", FECHA_GRAL.Date, "0", CUENTA_ENLACE, CUENTA_DESTINO, "0", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "0")
        '------------------------------------------------
        If CUENTA_DESTINO <> "" And CUENTA_ENLACE <> "" Then
            '------------------------------------------------
            'INSERTAR LAS CUENTAS AUTOMATICAS 
            ...
            DT_DET.Rows.Add(AÑO, MES, COD_AUX2, COD_COMP2, txt_nro_comp2.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE TOTAL DE DIFERENCIA DE CAMBIO", CUENTA_ENLACE, TOTAL0_PTE, 0, DH_ENLACE, "A", TC_ACT, "", "", "", "", FECHA_GRAL.Date, "0", "", "", "1", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "0")
            DT_DET.Rows.Add(AÑO, MES, COD_AUX2, COD_COMP2, txt_nro_comp2.Text, "", "", "", "", (DT_DET.Rows.Count + 1).ToString("0000"), FECHA_GRAL.Date, "", "", FECHA_GRAL.Date, "AJUSTE TOTAL DE DIFERENCIA DE CAMBIO", CUENTA_DESTINO, TOTAL0_PTE, 0, DH0_PTE, "A", TC_ACT, "", "", "", "", FECHA_GRAL.Date, "0", "", "", "1", "0", "0", "0", "", "", FECHA_GRAL.Date, 0, "", "0", FECHA_GRAL.Date, 0, NOMBRE_PC, "0")
        End If
        Try
            con.Open()
            sqlbc.DestinationTableName = "dbo.T_CON2"
        ...
        End Try
        Try
            Dim CMD As New SqlCommand("INSERTAR_I_CON_DIF_CAMBIO_BAN_PTE", con)
            CMD.CommandType = CommandType.StoredProcedure
    ...
    Sub SALDOS_CUENTAS()
        ...
        Do While (I <= CONT)
            If dgw1.Item(2, I).Value.ToString = "True" Then
                ...
                If obj.VERIFICAR_CIERRE_CUENTAS(COD_CUENTA0, AÑO, MES) = False Then Exit Sub
                Dim IMP As New Decimal
                Try
                    Dim cmd As New SqlCommand("DIF_CAMBIO_CONC_BAN", con)
                    cmd.CommandType = CommandType.StoredProcedure
    ...
    Sub SALDOS_CUENTAS_PTE()
        ...
        Do While (I <= CONT)
            If dgw2.Item(2, I).Value.ToString = "True" Then
                ...
                Dim IMP As New Decimal
                Try
                    Dim cmd As New SqlCommand("DIF_CAMBIO_PTE_BAN", con)
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.Add("@COD_CUENTA", SqlDbType.Char).Value = COD_CUENTA0
                    cmd.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
                    cmd.Parameters.Add("@FE_MES", SqlDbType.Char).Value = MES
    ...
    Function VERIFICAR_MSALDO_CUENTA() As Boolean
        ...
        Do While (I <= CONT)
            If dgw2.Item(2, I).Value.ToString = "True" Then
                ...
                Dim IMP As New Decimal
                Try
                    Dim cmd As New SqlCommand("VERIFICAR_SALDOS_MAESTROS_BAN", con)
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.Add("@COD_CUENTA", SqlDbType.Char).Value = COD_CUENTA0
                    cmd.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
                    cmd.Parameters.Add("@FE_MES", SqlDbType.Char).Value = MES
