...
Public Class CXP_CIERRE_CTAS
    ...
    Private Sub btn_aceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_aceptar.Click
        ...
        If obj.COD_MES(cbo_mes1.Text) <> "01" Then
            If VERIFICAR_CIERRE_MES_ANTERIOR() = True Then
                If VERIFICAR_CIERRE() = True And VERIFICAR_CONCILIACION() = True And VERIFICAR_MSALDO_CUENTA_PTE() = True Then
                    TC_ACT = obj.SACAR_CAMBIO_MENSUAL(AÑO, obj.COD_MES(cbo_mes1.Text), "D", "V")
                    ...
                    If (Decimal.Compare(TC_ACT, Decimal.Zero) <> 0) Then
                        ...
                        Do While (I <= CONT)
                            If dgw1.Item(2, I).Value = True Then
                                ...
                                Dim MES_ANT As String = obj.COD_MES(cbo_mes1.Text)
    ...
    Function VERIFICAR_CONCILIACION() As Boolean
        ...
        Return True
    End Function
    Function VERIFICAR_MSALDO_CUENTA_PTE() As Boolean
        ...
        Do While (I <= CONT)
            If dgw1.Item(2, I).Value = True Then
                ...
                Dim IMP As New Decimal
                Try
                    Dim cmd As New SqlCommand("VERIFICAR_SALDOS_MAESTROS_CXP_PTES", con)
                    cmd.CommandType = (CommandType.StoredProcedure)
                    cmd.Parameters.Add("@COD_CUENTA", SqlDbType.Char).Value = COD_CUENTA0
                    cmd.Parameters.Add("@FE_AÑO", SqlDbType.Char).Value = AÑO
                    cmd.Parameters.Add("@FE_MES", SqlDbType.Char).Value = obj.COD_MES(cbo_mes1.Text)
        ...
        Return True
    End Function
    Private Sub CXP_CIERRE_CTAS_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        SendKeys.Send("{tab}")
    End Sub
    Private Sub CXP_CIERRE_CTAS_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        KeyPreview = True
