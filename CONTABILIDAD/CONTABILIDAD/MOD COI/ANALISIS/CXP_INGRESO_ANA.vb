...
Public Class CXP_INGRESO_ANA
    Dim BOTON, COD_AUX, SOL, DOLAR, COD_COMP, COD_DOC, COD_MONEDA, COD_REF, MES00 As String
    ...
    Private Sub btn_eliminar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_eliminar.Click
        ...
        If MessageBox.Show("Desea borrar el Comprobante", " Borrar Comprobante?", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = 6 Then
            ...
            Try
                Dim comand1 As New SqlCommand("ELIMINAR_A_TCXP", con)
    ...
    Private Sub btn_eliminar2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_eliminar2.Click
        ...
        If OBJ.VERIFICAR_ELIMINAR_PCTAS_PAGAR(COD_DOC, txt_nro_doc0.Text, txt_cod_per0.Text, txt_nro_doc_per0.Text, txt_cod_cta0.Text) = False Then
    ...
    Private Sub btn_guardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_guardar.Click
        ...
        Else
            ...
            If VALIDAR_DGW(COD_DOC, txt_nro_doc0.Text, txt_cod_per0.Text, txt_cod_cta0.Text) = False Then
                ...
                txt_nro_doc0.Focus()
            ElseIf OBJ.VERIFICAR_PCTAS_PAGAR(COD_DOC, txt_nro_doc0.Text, txt_cod_per0.Text, txt_nro_doc_per0.Text, txt_cod_cta0.Text) = False Then
            ...
            Else
                ...
                dgw_mov1.Rows.Add(New Object() {txt_cod_cta0.Text, txt_glosa0.Text, SOL, DOLAR, cbo_d_h.Text, COD_MONEDA, txt_cambio0.Text, COD_DOC, txt_nro_doc0.Text, dtp_doc0.Value, txt_cod_per0.Text, txt_desc_per0.Text, txt_nro_doc_per0.Text, COD_REF, txt_nro_ref0.Text, txt_imp_soles0.Text, dtpFechaVen.Value})
                HALLAR_TOTAL()
                LIMPIAR_DOCUMENTO()
                txt_cod_per0.Focus()
            End If
    ...
    Sub CARGAR_COMPROBANTE()
        ...
        dgw_mov1.Rows.Clear()
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_T_A_TCXP", con)
    ...
    Sub DATAGRID()
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_A_TCXP", con)
            pro_02.CommandType = (CommandType.StoredProcedure)
            pro_02.Parameters.Add("@fe_año", SqlDbType.VarChar).Value = AÑO
            pro_02.Parameters.Add("@fe_mes", SqlDbType.VarChar).Value = MES00
    ...
    Function INSERTAR_TODO() As String
        ...
        Try
            con.Open()
            sqlbc.DestinationTableName = ("dbo.ANALISIS_TCXP2")
        ...
        End Try
        Try
            Dim comand1 As New SqlCommand("INSERTAR_A_TCXP", con)
            comand1.CommandType = (CommandType.StoredProcedure)
            comand1.Parameters.Add("@cod_aux", SqlDbType.VarChar).Value = COD_AUX
            comand1.Parameters.Add("@cod_comP", SqlDbType.VarChar).Value = COD_COMP
            comand1.Parameters.Add("@nro_comP", SqlDbType.VarChar).Value = txt_nro_comp.Text
    ...
    Function MODIFICAR_TODO() As String
        ...
        End Try
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_A_TCXP", con)
            comand1.CommandType = (CommandType.StoredProcedure)
            comand1.Parameters.Add("@cod_aux", SqlDbType.VarChar).Value = (COD_AUX)
            comand1.Parameters.Add("@cod_comP", SqlDbType.VarChar).Value = (COD_COMP)
            comand1.Parameters.Add("@nro_comP", SqlDbType.VarChar).Value = (txt_nro_comp.Text)
    ...
    Function VALIDAR_DGW(ByVal cod_doc_03 As String, ByVal nro_doc_03 As String, ByVal cod_per_03 As String, ByVal COD_CTA_03 As String) As Boolean
        ...
        Return True
    End Function
    Private Sub CXP_INGRESO_ANA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Return) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
    Private Sub CXP_INGRESO_ANA_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        KeyPreview = True
            ...
            If ofd.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Try
                    ...
                    Using cnn As New OleDbConnection(conExcel)
                        Dim cmd As New OleDbCommand("Select * from [CXP$]", cnn)
