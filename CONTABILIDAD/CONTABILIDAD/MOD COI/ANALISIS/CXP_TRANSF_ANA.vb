...
Public Class CXP_TRANSF_ANA
    ...
    Private Sub btn_aceptar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_aceptar.Click
        ...
        Do While (j <= k)
            ...
            If dgw1.Item(2, j).Value = True Then
                ...
                Try
                    Dim cmd As New SqlCommand("TRANSFERIR_CTAS_CXP", con)
        ...
        Else
            ...
            Do While (I <= CONT)
                If dgw2.Item(2, I).Value = True Then
                    If OBJ.VERIFICAR_CIERRE_CUENTAS(dgw2.Item(0, I).Value.ToString, AÑO, OBJ.COD_MES(cbo_mes2.Text)) = False Then Exit Sub
    ...
    Sub DESCONCILIAR_CUENTA(ByVal cod_cta As String)
        Try
            Dim cmd As New SqlCommand("DESTRANSFERIR_CTAS_CXP", con)
            cmd.CommandType = (CommandType.StoredProcedure)
            cmd.Parameters.Add("@fe_año", SqlDbType.Char).Value = AÑO
