...
Public Class GENERACION_CXP
    Dim BOTON, STATUS_PV, STATUS_P, STATUS_CC, ENLACE, DESTINO, COD_P, COD_AUX, COD_C, COD_CC, COD_COMP, COD_DH_DOC, COD_DOC, COD_MONEDA As String
    ...
    Sub CARGAR_COMPROBANTE()
        ...
        Try
            Dim PRO_02 As New SqlCommand("MOSTRAR_T_CON_CXP_GENERACION", con)
    ...
    Sub DATAGRID()
        Try
            ...
            pro_02.Parameters.Add("@fe_año", SqlDbType.VarChar).Value = AÑO
            pro_02.Parameters.Add("@fe_mes", SqlDbType.VarChar).Value = MES
            pro_02.Parameters.Add("@tipo", SqlDbType.VarChar).Value = ("CPGEN")
    ...
    Sub ELIMINAR_DOCUMENTO_DGW(ByVal fila_doc0 As Integer)
        ...
        Do While (I < CONT)
            'If Conversions.ToBoolean(Operators.AndObject(Operators.AndObject(Operators.AndObject(Operators.CompareObjectEqual(dgw_det_01.Item(20, I).Value, cod_doc_05, False), Operators.CompareObjectEqual(dgw_det_01.Item(21, I).Value, nro_doc_05, False)), Operators.CompareObjectEqual(dgw_det_01.Item(22, I).Value, cod_per_05, False)), Operators.CompareObjectEqual(dgw_det_01.Item(23, I).Value, nro_doc_per_05, False))) Then
    ...
    Sub HALLAR_TOTAL_DOC()
        ...
        Do While (I <= CONT)
            ...
            I += 1
        Loop
        'HABER_SOLES = DEBE_SOLES
        'HABER_DOLARES = DEBE_DOLARES
        ...
        txt_saldo_soles.Text = (Decimal.Subtract(DEBE_SOLES, HABER_SOLES))
        txt_saldo_dolares.Text = (Decimal.Subtract(DEBE_DOLARES, HABER_DOLARES))
    ...
    Sub INSERTAR_DOCUMENTO_DGW()
        ...
        Else
            imp_t00 = imp_d_t
        End If
        'Dim VB$t_array$S0 As Object() = New Object() { (CONT + 2).ToString("0000"), txt_cta_total.Text, txt_desc_per.Text, imp_s_t, imp_d_t, DH_T, COD_MONEDA, txt_cambio.Text, " ", " ", " ", "", dtp_vence.Value, 0, " ", " ", " ", " ", " ", dtp_doc.Value, COD_DOC, txt_nro_doc.Text, txt_cod_per0.Text, txt_doc_per.Text, 0, "T", "", "", "0", " ", " ", dtp_doc.Value, 0, " ", 0, imp_t00, "0", "0" }
    ...
    Function INSERTAR_TODO() As String
        ...
        End Try
        Try
            Dim comand1 As New SqlCommand("INSERTAR_I_CON_CXP_GENERACION", con)
            comand1.CommandType = (CommandType.StoredProcedure)
            comand1.Parameters.Add("@cod_aux", SqlDbType.VarChar).Value = (COD_AUX)
            comand1.Parameters.Add("@cod_comP", SqlDbType.VarChar).Value = (COD_COMP)
            comand1.Parameters.Add("@nro_comP", SqlDbType.VarChar).Value = (txt_nro_comp.Text)
    ...
    Function MODIFICAR_TODO() As String
        ...
        End Try
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_I_CON_CXP_GENERACION", con)
            comand1.CommandType = (CommandType.StoredProcedure)
            comand1.Parameters.Add("@cod_aux", SqlDbType.VarChar).Value = COD_AUX
            comand1.Parameters.Add("@cod_comP", SqlDbType.VarChar).Value = COD_COMP
            comand1.Parameters.Add("@nro_comP", SqlDbType.VarChar).Value = (txt_nro_comp.Text)
    ...
    Private Sub txt_cta_total_LostFocus(ByVal sender As Object, ByVal e As EventArgs) Handles txt_cta_total.LostFocus
        ...
        Else
            ...
            'Dim VB$t_i4$L0 As Integer = (dgw_cta_t.RowCount - 1)
            Dim i As Integer = 0
            ...
            Else
                ...
                Do While (i <= (dgw_cta_imp.RowCount - 1))
                    If (txt_desc_cta_imp.Text.ToLower = Strings.Mid((dgw_cta_imp.Item(1, i).Value), 1, Strings.Len(txt_desc_cta_imp.Text)).ToLower) Then
                        ...
                        Exit Do
                    End If
                    dgw_cta_imp.CurrentCell = (dgw_cta_imp.Rows.Item(1).Cells.Item(1))
                    i += 1
                Loop
                Panel_cta_det.Visible = True
                dgw_cta_imp.Visible = True
    ...
    Private Sub GENERACION_CXP_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = True
        End If
    End Sub

    Private Sub GENERACION_CXP_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = False
        End If
    End Sub
