...
Public Class DEPURAR_TCTAS_COBRAR
    ...
    Private Sub Procesar()
        Try
            Dim Cmd As New SqlCommand("MOSTRAR_PCTAS_COBRAR_CANCELADAS", con)
            Cmd.CommandType = CommandType.StoredProcedure
            Dim par0 As SqlParameter = Cmd.Parameters.Add("@FE_AÑO", SqlDbType.Char)
            ...
            If dtDatos.Rows.Count > 0 Then
                ...
                For Each dr In dtDatos.Rows
                    ...
                    Cmd = New SqlCommand("ELIMINAR_PCTAS_COBRAR", con)
                    Cmd.CommandType = CommandType.StoredProcedure
            ...
            Cmd = New SqlCommand("ELIMINAR_TCTAS_COBRAR_NO_PCTAS_COBRAR", con)
            Cmd.CommandType = CommandType.StoredProcedure
