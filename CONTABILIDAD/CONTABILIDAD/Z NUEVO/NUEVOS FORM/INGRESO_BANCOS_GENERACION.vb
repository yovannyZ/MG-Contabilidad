...
Imports System.Text
Public Class INGRESO_BANCOS_GENERACION
    ...
    Private Sub btn_eliminar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_eliminar.Click
        ...
        ElseIf (Decimal.Parse((CInt(MessageBox.Show("Desea eliminar el Comprobante", "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            ...
            Else
                ...
                Try
                    Dim comand1 As New SqlCommand("ELIMINAR_I_BAN_INGRESO2", con)
    ...
    Sub DATAGRID()
        Try
            Dim pro As New SqlCommand("MOSTRAR_I_BAN_INGRESO2", con)
    ...
    Private Sub INGRESO_BANCOS_GENERACION_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = True
        End If
    End Sub

    Private Sub INGRESO_BANCOS_GENERACION_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = False
        End If
    End Sub
    ...
    Private Sub btn_guardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_guardar.Click
        'If OBJ.VERIFICAR_CTA_ORIGEN_CPTO(txt_cod_cta.Text) = "" Then
        ...
        Else
            ...
            Else
                ...
                Else
                    dgw_mov1.Rows.Add((dgw_mov1.RowCount + 1).ToString("0000"), COD_DOC, txt_nro_doc.Text, txt_cod1.Text, txt_desc_per.Text, txt_nro_doc_per.Text, IMP_S, imp_pago, COD_MON_DOC, COD_D_H, txt_cambio.Text, dtp_mp.Value, txt_glosa.Text, txt_cod_cta.Text, TXT_CTA.Text, dtp_vcto.Value, COD_CC, COD_CONTROL, COD_PROYECTO, STATUS_CC, "1", STATUS_P, STATUS_PER, VAR_PRO)
                    HALLAR_TOTAL()
                    LIMPIAR_DETALLES()
                    txt_cod1.Focus()
                End If
    ...
    Private Sub btn_modificar2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_modificar2.Click
        Dim WA As String
        WA = OBJ.HALLAR_CPTO(txt_cod_cta.Text, "I")
        If WA = "" Then
        ...
        Try
            ...
            Do While rs3.Read
                dgw_mov1.Rows.Add((rs3.GetValue(0)), rs3.GetValue(1), rs3.GetValue(2), rs3.GetValue(3), _
                    ...
                    (rs3.GetValue(14)), (rs3.GetValue(15)), (rs3.GetValue(16)), rs3.GetValue(17), _
                ...
                dgw_det2.Rows.Add((rs3.GetValue(0)), rs3.GetValue(1), rs3.GetValue(2), rs3.GetValue(3), _
                    rs3.GetValue(4), rs3.GetValue(5), rs3.GetValue(6), rs3.GetValue(7), rs3.GetValue(8), _
                    rs3.GetValue(9), rs3.GetValue(10), (rs3.GetValue(11)), (rs3.GetValue(12)), (rs3.GetValue(13)), _
                    (rs3.GetValue(14)), (rs3.GetValue(15)), (rs3.GetValue(16)), rs3.GetValue(17), _
                    rs3.GetValue(18), rs3.GetValue(19), rs3.GetValue(20), rs3.GetValue(21), rs3.GetValue(22), _
    ...
    Function INSERTAR_TODO() As String
        ...
        If OBJ.DIR_TABLA_DESC("GCO", "TSIST") = "SI" Then
            ...
            End Try
            Try
                Dim comand As New SqlCommand("COI_INSERTAR_T_BAN_INGRESO2", CON_GCO)
        ...
        Try
            ...
            Dim comand1 As New SqlCommand("INSERTAR_I_BAN_INGRESO2", con)
            comand1.CommandType = CommandType.StoredProcedure
            ...
            comand1.Parameters.Add("@STATUS_CONTROL", SqlDbType.VarChar).Value = ST_CONTROL
            con.Open()
            estado = (comand1.ExecuteScalar)
    ...
    Function MODIFICAR_TODO() As String
        ...
        If ch_control.Checked = True Then ST_CONTROL = "1" Else ST_CONTROL = "0"
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_I_BAN_INGRESO2", con)
            comand1.CommandType = CommandType.StoredProcedure
            comand1.Parameters.Add("@COD_AUX", SqlDbType.VarChar).Value = COD_AUX
            comand1.Parameters.Add("@COD_COMP", SqlDbType.VarChar).Value = COD_COMP
            comand1.Parameters.Add("@NRO_COMP", SqlDbType.VarChar).Value = txt_nro_comp.Text
        ...
        Do While (I <= CONT)
            Try
                If dgw_mov1.Item(27, I).Value <> "M" Then
                    ...
                    par5.Value = dgw_mov1.Item(14, I).Value : par6.Value = 2
