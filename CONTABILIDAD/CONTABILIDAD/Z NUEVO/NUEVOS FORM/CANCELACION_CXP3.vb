...
Public Class CANCELACION_CXP3
    Dim BOTON, VAR_PRO, STATUS_PER, AGREGAR_PAGO, STATUS_P, COD_COMP2 As String
    Dim COD_AUX2, STATUS_DOC, STATUS_CC, STATUS_ANA, ITEM_PAGO, cod_ref As String
    Dim COD_PROYECTO, COD_MP, COD_MONEDA, COD_MON_DOC, COD_AUX, COD_CC, COD_COMP As String
    Dim COD_CONTROL, COD_D_H, COD_D_H_PAGO, COD_DOC, ENLACE, DESTINO As String
    ...
    Private Sub btn_eliminar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_eliminar.Click
        ...
        If (Decimal.Parse((CInt(MessageBox.Show("Desea borrar el Comprobante", " Borrar Comprobante?", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)))) = 6) Then
            ...
            Try
                Dim comand1 As New SqlCommand("ELIMINAR_I_CON_CXP_PAGO", con)
    ...
    Private Sub btn_nuevo_doc_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_nuevo_doc.Click
        ...
        If STATUS_ANA = "C" AndAlso ch_a.Checked Then
            MessageBox.Show("La Cuenta es por Cobrar", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            ch_a.Focus()
            Exit Sub
        End If
    ...
    Private Sub CANCELACION_CXP3_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = True
        End If
    End Sub

    Private Sub CANCELACION_CXP3_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Deactivate
        If TabControl1.SelectedIndex <> 0 Then
            ValidarFicha = False
        End If
    End Sub
    ...
    Sub CARGAR_COMPROBANTE()
        ...
        dgw_mov.Rows.Clear()
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_T_CON_CXP_PAGO", con)
    ...
    Sub CARGAR_CUENTAS()
        Try
            Dim pro As New SqlCommand("DGW_CUENTA_PAGO_CXP", con)
            pro.CommandType = CommandType.StoredProcedure
    ...
    Sub DATAGRID()
        Try
            Dim pro_02 As New SqlCommand("MOSTRAR_ICON_CXP", con)
            pro_02.CommandType = CommandType.StoredProcedure
            pro_02.Parameters.Add("@fe_año", SqlDbType.VarChar).Value = AÑO
            pro_02.Parameters.Add("@fe_mes", SqlDbType.VarChar).Value = MES
            pro_02.Parameters.Add("@TIPO", SqlDbType.VarChar).Value = "CPCAN"
        ...
        Do While (I <= CONT)
            If (dgw_mov1.Item(9, I).Value.ToString = "D") Then
                ...
                Select Case dgw_mov1.Item(8, I).Value.ToString
                    Case "D"
                        D_DOLARES = D_DOLARES + Math.Round((CDec(dgw_mov1.Item(7, I).Value)), 2, MidpointRounding.AwayFromZero)
                        D_SOLES = D_SOLES + Math.Round((CDec(dgw_mov1.Item(7, I).Value)) * txt_cambio_pago.Text, 2, MidpointRounding.AwayFromZero)
                    Case "S"
                        D_DOLARES = D_DOLARES + Math.Round((CDec(dgw_mov1.Item(7, I).Value)) / txt_cambio_pago.Text, 2, MidpointRounding.AwayFromZero)
                        D_SOLES = D_SOLES + Math.Round((CDec(dgw_mov1.Item(7, I).Value)), 2, MidpointRounding.AwayFromZero)
                    Case "A"
            ...
            Else
                Select Case dgw_mov1.Item(8, I).Value.ToString
                    Case "D"
                        H_DOLARES = H_DOLARES + Math.Round((CDec(dgw_mov1.Item(7, I).Value)), 2, MidpointRounding.AwayFromZero)
                        H_SOLES = H_SOLES + Math.Round((CDec(dgw_mov1.Item(7, I).Value) * txt_cambio_pago.Text), 2, MidpointRounding.AwayFromZero)
                    Case "S"
                        H_DOLARES = H_DOLARES + Math.Round((CDec(dgw_mov1.Item(7, I).Value) / txt_cambio_pago.Text), 2, MidpointRounding.AwayFromZero)
                        H_SOLES = H_SOLES + Math.Round((CDec(dgw_mov1.Item(7, I).Value)), 2, MidpointRounding.AwayFromZero)
                    Case "A"
    ...
    Sub INSERTAR_DGW_PAGO()
        ...
        Else
            AGREGAR_PAGO = "0"
        End If
        dgw_pago0.Rows.Add(COD_MP, cbo_mp.Text, txt_cod_cta_pago.Text, txt_desc_cta_pago.Text, txt_nro_mp.Text, _
        dtp_mp.Value, TXT_PAGO.Text, COD_MONEDA, txt_cambio_pago.Text, ITEM0, COD_DOC_EQ, txt_nro_mp.Text, _
        dtp_mp.Value, txt_glosa_pago.Text, COD_DOC_EQ, "", txt_cod_per_cab.Text, txt_des_per_cab.Text, _
        txt_doc_per_cab.Text, AGREGAR_PAGO, dtp_vcto.Value)
        ...
        Do While (I <= CONT)
            ...
            Select Case dgw_mov1.Item(8, I).Value.ToString
                Case "D"
                    ...
                    'impdolares = Math.Round(Double.Parse(dgw_mov1.Item(7, I).Value), 2, MidpointRounding.AwayFromZero)
                ...
                Case "S"
                    ...
                    'impdolares = Double.Parse(dgw_mov1.Item(7, I).Value / txt_cambio_pago.Text)
            ...
            With dgw_mov1
                ...
                .Item(23, I).Value, .Item(24, I).Value, dtp_mp.Value, ITEM0, "0", impsoles, impdolares, "0", _
    ...
    Function INSERTAR_TODO() As String
        ...
        End Try
        Try
            Dim comand1 As New SqlCommand("INSERTAR_I_CON_CXP_PAGO", con)
            comand1.CommandType = CommandType.StoredProcedure
            comand1.Parameters.Add("@cod_aux", SqlDbType.VarChar).Value = COD_AUX
            comand1.Parameters.Add("@cod_comP", SqlDbType.VarChar).Value = COD_COMP
            comand1.Parameters.Add("@nro_comP", SqlDbType.VarChar).Value = txt_nro_comp.Text
            ...
            comand1.Parameters.Add("@fe_mes", SqlDbType.VarChar).Value = MES
            comand1.Parameters.Add("@nombre_pc", SqlDbType.VarChar).Value = NOMBRE_PC
            'comand1.Parameters.Add("@DESC_PER_CAB", SqlDbType.VarChar).Value = txt_des_per_cab.Text
    ...
    Function MODIFICAR_TODO() As String
        ...
        Do While (I <= CONT)
            ...
            SOLES = Math.Round(Decimal.Parse((dgw_mov.Item(27, I).Value)), 2)
            'Dim SO0 As Decimal = dgw_mov.Item(27, I).Value
            'SOLES = Math.Round(SO0 , 2, MidpointRounding.AwayFromZero)
            DOLARES = Math.Round(Decimal.Parse((dgw_mov.Item(28, I).Value)), 2)
            ...
            'DT_DET.Rows.Add(AÑO, MES, COD_AUX, COD_COMP, txt_nro_comp.Text, dgw_mov.Item(1, I).Value, _
            'dgw_mov.Item(2, I).Value, (dgw_mov.Item(4, I).Value), (dgw_mov.Item(6, I).Value), _
            '(I + 1).ToString("0000"), (dgw_mov.Item(3, I).Value), (dgw_mov.Item(22, I).Value), _
            '(dgw_mov.Item(23, I).Value), (dgw_mov.Item(24, I).Value), (dgw_mov.Item(11, I).Value), _
            '(dgw_mov.Item(12, I).Value), SOLES, DOLARES, (dgw_mov.Item(7, I).Value), (dgw_mov.Item(9, I).Value), _
            '(dgw_mov.Item(10, I).Value), (dgw_mov.Item(13, I).Value), (dgw_mov.Item(14, I).Value), _
            '(dgw_mov.Item(15, I).Value), " ", (dgw_mov.Item(17, I).Value), dgw_mov.Item(29, I).Value, _
            '"", "", "0", VAR_PRO00, "0", dgw_mov.Item(26, I).Value.ToString, (dgw_mov.Item(0, I).Value), _
            'dgw_mov.Item(23, I).Value.ToString, (dgw_mov.Item(3, I).Value), (dgw_mov.Item(25, I).Value), _
            '"", VAR_PRO00, dtp_com.Value, 0, NOMBRE_PC)
            I += 1
        Loop
        Try
        ...
        End Try
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_I_CON_CXP_PAGO", con)
            comand1.CommandType = CommandType.StoredProcedure
            comand1.Parameters.Add("@cod_aux", SqlDbType.VarChar).Value = COD_AUX
            comand1.Parameters.Add("@cod_comP", SqlDbType.VarChar).Value = COD_COMP
            comand1.Parameters.Add("@nro_comP", SqlDbType.VarChar).Value = txt_nro_comp.Text
    ...
    Sub PERSONAS()
        Try
            ...
            DGW_PER_CAB.DataSource = obj.MOSTRAR_PERSONAS_PAGAR
    ...
    Private Sub cbo_com2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_com2.SelectedIndexChanged, cboAutomatica.SelectedIndexChanged
    ...
    Sub BOTON4()
        ...
        OFR.CARGAR_PCTAS_PAGAR_X_COMPROBANTE()
        OFR.limpiar()
        OFR.ShowDialog()
        If (OFR.DialogResult = Windows.Forms.DialogResult.OK) Then
            If (OFR.LBL.Text = "NO") Then
    ...
    Private Sub txt_glosa_pago_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_glosa_pago.LostFocus
        If STATUS_ANA = "P" Or STATUS_ANA = "C" Then
            ch_a.Enabled = True
            dtp_vcto.Enabled = True
            dtp_vcto.Focus()
        Else
