...
Public Class CONSULTA_LETRAS_CXC
    ...
    Sub CARGAR_CONSULTA_CANC()
        DGW_DET2.Rows.Clear()
        Try
            Dim command As New SqlCommand("MOSTRAR_LETRAS_CONSULTA_CANC2", con)
    ...
    Sub CARGAR_CONSULTA_PTE()
        DGW_DET1.Rows.Clear()
        Try
            Dim command As New SqlCommand("MOSTRAR_LETRAS_CONSULTA_PTES2", con)
            command.CommandType = CommandType.StoredProcedure
    ...
    Sub CARGAR_MOD_ACEPTACION()
        dgw_det3.Rows.Clear()
        Try
            Dim command As New SqlCommand("MOSTRAR_LETRAS_PARA_ACEP2", con)
            command.CommandType = CommandType.StoredProcedure
    ...
    Sub CARGAR_MOD_UBICACION_NRO_BANCO()
        DGW_DET4.Rows.Clear()
        Try
            Dim command As New SqlCommand("MOSTRAR_LETRAS_PARA_UBI_BAN2", con)
            command.CommandType = CommandType.StoredProcedure
    ...
    Sub CARGAR_PERSONAS()
        Try
            Dim selectCommand As New SqlCommand("MOSTRAR_PERSONAS_XCOBRAR", con)
