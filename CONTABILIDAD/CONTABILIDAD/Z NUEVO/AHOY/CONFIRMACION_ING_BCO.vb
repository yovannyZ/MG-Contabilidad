...
Public Class CONFIRMACION_ING_BCO
  ...
  Sub DATAGRID()
        Try
            Dim pro As New SqlCommand("MOSTRAR_I_BAN_INGRESO_CONFIRMACION", con)
    ...
    Function MODIFICAR_TODO() As String
        ...
        Try
            Dim comand1 As New SqlCommand("MODIFICAR_I_BAN_INGRESO_CONFIRMACION", con)
    ...
    Sub PERSONAS()
        ...
        Try
            ...
            '----------------------------------------------
            DGW_PER22.DataSource = OBJ.MOSTRAR_PERSONAS_COBRAR
