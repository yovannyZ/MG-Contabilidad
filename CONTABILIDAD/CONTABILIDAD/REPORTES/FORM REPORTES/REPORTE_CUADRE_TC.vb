...
Public Class REPORTE_CUADRE_TC
    ...
    Private Sub REPORTE_CUADRE_TC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For i = 0 To dgw2.Rows.Count - 1
            ...
            If dgw2.Item(2, i).Value = True Then
                Try
                    ...
                    Dim cmd As New SqlCommand("ACTUALIZA_MOVXC", con)
                    cmd.CommandType = CommandType.StoredProcedure
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_pantalla1.Click
        ...
        For i = 0 To dgw1.Rows.Count - 1
            ...
            End If
        Next
        _criterio = Mid(_criterio, 1, Len(_criterio) - 1)
        If rb1.Checked = True Then
            _rep = "Reporte_Cuadre_TC.rpt"
            _title = "Reporte cuadre Analisis vs Cuentas por cobrar"
        ElseIf rb2.Checked = True Then
            _rep = "Reporte_Cuadre_PCvsTC.rpt"
            _title = "Reporte cuadre Cuentas por cobrar"
        ElseIf rb3.Checked = True Then
            _rep = "Reporte_Cuadre_PCvsTC_DOC.rpt"
            _title = "Reporte cuadre Cuentas por cobrar(Existencia de Documentos)"
        End If
        CR.conectar(nombre_servidor, con.Database, "miguel", "main")
        CR.rutaRpt = Application.StartupPath & "\reportes"
        CR.custTitle = _title
        CR.printrpt(_rep, "@IN;" & _criterio, "EMPRESA;" & DESC_EMPRESA, "RUC;" & RUC_EMPRESA, _
