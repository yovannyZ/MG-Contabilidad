...
Public Class REPORTE_BALANCE_PER
    Private COD_FORMATO, OBS As String
    Private OBJ As New Class1
    Private OFR As New REP_BALANCE_PER
    Private TEXTO_SELECT As String
    Private TEXTO_SELECT2 As String
    ...
    Public Function CARGAR_SALDOS() As Boolean
        ...
        End Try
        Try
            Dim CMD2 As New SqlCommand("ACT_PORCENTAJE_FORMATO2", con)
            CMD2.CommandType = CommandType.StoredProcedure
            CMD2.Parameters.Add("@COD_FORMATO", SqlDbType.Char).Value = COD_FORMATO
            con.Open()
            CMD2.ExecuteNonQuery()
    ...
    Private Sub REPORTE_BALANCE_PER_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
