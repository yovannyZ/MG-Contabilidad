...
Public Class REPORTE_CUADRE_TC1
    Dim OBJ As New Class1
    Private CADENA_CUENTA As String
    Private Ofrm As New REP_CUADRE_TC1
    ...
    Private Sub REPORTE_CUADRE_TC1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_pantalla1.Click
        ...
        If Not rb1.Checked AndAlso Not rb2.Checked Then MessageBox.Show("Seleccione el tipo de presentación", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : rb1.Focus() : Exit Sub
        ...
        If rb1.Checked Then Ofrm.op = 1 Else Ofrm.op = 0
