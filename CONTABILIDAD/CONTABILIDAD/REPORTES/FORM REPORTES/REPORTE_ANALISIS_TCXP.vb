...
Public Class REPORTE_ANALISIS_TCXP
    Private MES0, HOJA As String
    Private obj As New Class1
    Private REP1 As New REP_CONCILIADO
    Private REP2 As New REP_PENDIENTE
    ...
    Private Sub ExportarWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs)
        ...
        Try
            ...
            If ch_p.Checked Then
                stCon = 0
                archivoExcel = "AnalisisCXPPendientes" & txt_cod_cta0.Text
            Else
                stCon = 1
                archivoExcel = "AnalisisCXPConciliadas" & txt_cod_cta0.Text
            End If
    ...
    Private Sub txt_desc_cta0_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_desc_cta0.TextChanged
