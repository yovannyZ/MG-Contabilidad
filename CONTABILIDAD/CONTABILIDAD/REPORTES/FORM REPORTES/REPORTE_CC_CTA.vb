...
Public Class REPORTE_CC_CTA
    Dim OBJ As New Class1
    Dim REP As New REP_CC_CTAS
    Dim ST_CTA, COD_CTA, COD_MONEDA As String
    Dim P1 As Integer = 0
    Dim P2 As Integer = 0
    Dim P3 As Integer = 0
    Dim P4 As Integer = 0
    ...
    Private Sub REPORTE_CC_CTA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Return) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
    Private Sub REPORTE_CC_CTA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        KeyPreview = True
        CUENTAS()
    End Sub
    Sub CUENTAS()
    ...
    Private Sub btn_salir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_salir.Click
        ...
        Close()
    End Sub
    Private Sub ch_cta_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ch_cta.CheckedChanged
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_pantalla1.Click
        ...
        End If
        LLENAR_DATASET()
        REP.CREAR_REPORTE(cbo_mes2.Text, COD_CTA, ST_CTA, COD_MONEDA, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, cbo_moneda.Text)
        REP.ShowDialog()
    End Sub
    Sub LLENAR_DATASET()
        REP.DT_CC_T_CON.REPORTE_CC_CTAS2.Rows.Clear()
        'REP.LIMPIAR()
        Try
            Dim PROG_01 As New SqlCommand("REPORTE_CC_CTAS", con)
            PROG_01.CommandType = CommandType.StoredProcedure
            PROG_01.CommandTimeout = 720
            PROG_01.Parameters.Add("@ST_CTA", SqlDbType.Char).Value = ST_CTA
            PROG_01.Parameters.Add("@COD_CTA", SqlDbType.VarChar).Value = COD_CTA
    ...
    Private Sub ExportarWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs)
        ...
        Try
            ...
            oHoja.Cells(5, 1) = "Cod. Cta." : oHoja.Cells(6, 2) = "Cuenta"
            oHoja.Cells(5, 3) = "Cod. CC." : oHoja.Cells(5, 4) = "CC"
