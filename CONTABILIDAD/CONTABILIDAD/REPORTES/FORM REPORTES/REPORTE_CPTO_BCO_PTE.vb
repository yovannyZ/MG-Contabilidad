...
Public Class REPORTE_CPTO_BCO_PTE
    Dim cod_moneda As String
    Dim obj As New Class1
    Dim REP As New REP_CPTO_BCO_PTE
    Private Sub btn_pantalla1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla1.Click
        ...
        REP.CREAR_REPORTE(dtp_del.Value.Date, dtp_al.Value.Date, cod_ban, txt_desc_ban.Text, txt_cod_cta.Text, desc_moneda)
        REP.ShowDialog()
    End Sub
