...
Public Class REPORTE_ANA_TC
    Dim OBJ As New Class1
    Dim ofr1 As New REP_ANA_TC
    Private Sub REPORTE_ANA_TC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub REPORTE1()
        ...
        For I = 0 To cont
            If dgw1.Item(2, I).Value = True Then
                Try
                    Dim PROG_01 As New SqlCommand("REPORTE_ANALISIS_VS_TCTAS_COBRAR", con)
                    ...
                    While Rs3.Read
                        ofr1.llenar_dt((Rs3.GetValue(0)), Rs3.GetValue(1), Rs3.GetValue(2), Rs3.GetValue(3), Rs3.GetValue(4), Rs3.GetValue(5), Rs3.GetValue(6), Rs3.GetValue(7), Rs3.GetValue(8), Rs3.GetValue(9), Rs3.GetValue(10), Rs3.GetValue(11), Rs3.GetValue(12), Rs3.GetValue(13), Rs3.GetValue(14))
                    End While
                    con.Close()
                Catch ex As Exception
                    con.Close()
