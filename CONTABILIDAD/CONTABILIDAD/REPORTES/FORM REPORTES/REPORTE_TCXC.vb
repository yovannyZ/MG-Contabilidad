...
Public Class REPORTE_TCXC
    Dim MES0 As String
    Dim obj As New Class1
    Dim REP2 As New REP_TCXC
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla1.Click
        ...
        Else
            ...
            End If
        End If
        REP2.CREAR_REPORTE(cbo_mes.Text, txt_desc_cta0.Text, txt_cod_cta0.Text, cbo_año.Text, MES0, "0", COD_PER, STATUS_PER, FECHA_CONC)
        REP2.ShowDialog()
    End Sub
