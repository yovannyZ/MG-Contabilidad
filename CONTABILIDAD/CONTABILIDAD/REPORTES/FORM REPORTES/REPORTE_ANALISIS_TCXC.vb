...
Public Class REPORTE_ANALISIS_TCXC
    Dim MES0, HOJA As String
    Dim obj As New Class1
    Dim REP1 As New REP_CONCILIADO_CXC
    Dim REP2 As New REP_PENDIENTE_CXC
    ...
    Private Sub ExportarWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs)
        ...
        Try
            ...
            If ch_p.Checked Then
                archivoExcel = "AnalisisCXCPendientes" & txt_cod_cta0.Text
            Else
                stCon = 1
                archivoExcel = "AnalisisCXCConciliadas" & txt_cod_cta0.Text
            End If
