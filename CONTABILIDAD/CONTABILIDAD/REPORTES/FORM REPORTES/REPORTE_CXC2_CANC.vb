...
Public Class REPORTE_CXC2_CANC
    Dim COD_CLASE1, COD_CLASE2, STATUS_SUC2, STATUS_SUC1, COD_PER1, COD_PER2, COD_SUCURSAL1, COD_SUCURSAL2, STATUS_PER1, STATUS_PER2 As String
    Dim OBJ As New Class1
    Dim ofr1 As New REP_CXC_CANC1
    ...
    Private Sub btn_pantalla2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla2.Click
        ...
        If ch_si2.Checked Then
            STATUS_SUC2 = "0"
            COD_SUCURSAL2 = Me.cbo_sucursal2.SelectedValue.ToString
        Else
            STATUS_SUC2 = "1"
            COD_SUCURSAL2 = "  "
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        ofr1.UBICAR_REPORTE()
        '------------------------
        ofr1.CREAR_REPORTE(dtp05.Value.ToString.Substring(0, 10), dtp06.Value.ToString.Substring(0, 10))
        ofr1.parametros(COD_SUCURSAL2, " ", STATUS_SUC2, "1", dtp05.Value, dtp06.Value, ST_BANCO, COD_BANCO)
        ofr1.ShowDialog()
    End Sub
End Class