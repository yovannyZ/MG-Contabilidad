...
Public Class REPORTE_CXP1
    Dim COD_CLASE02, STATUS_SUC3, STATUS_SUC2, STATUS_SUC1, STATUS_SUC02, STATUS_PER3, STATUS_PER2, STATUS_PER1, STATUS_DOC3, STATUS_DOC2, STATUS_DOC1, STATUS_DOC02, COD_SUCURSAL3, COD_SUCURSAL2, COD_SUCURSAL1, COD_SUCURSAL02, COD_PER3, COD_PER2, COD_DOC3, COD_PER1, COD_DOC2, COD_DOC1, COD_CLASE1, COD_CLASE2, COD_CLASE3, COD_DOC02 As String
    Dim OBJ As New Class1
    Dim ofr1 As New REP_CXP_PTE1
    Dim ofr2 As New REP_CXP_PTE2
    Dim ofr3 As New REP_CXP_PTE3
  ...
  Private Sub btn_pantalla02_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla02.Click
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla1.Click
        ...
        If ch_si1.Checked Then
            STATUS_SUC1 = "0"
            COD_SUCURSAL1 = Me.CBO_SUCURSAL1.SelectedValue.ToString
        Else
            STATUS_SUC1 = "1"
            COD_SUCURSAL1 = "  "
        End If
        ...
        ofr1.CREAR_REPORTE(COD_SUCURSAL1, STATUS_SUC1, Now.Date, dtp02.Value.Date, STATUS_PER1, COD_PER1, STATUS_DOC1, COD_DOC1, "1", "")
        ofr1.ShowDialog()
    End Sub
    ...
    Private Sub TXT_DESC_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles TXT_DESC1.KeyDown
        If ((e.KeyData = Keys.Return) AndAlso (Strings.Trim(TXT_DESC1.Text) <> "")) Then
            If (dgw_per1.RowCount = 0) Then
                MessageBox.Show("No existen PERSONAS X PAGAR", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Else
                Me.dgw_per1.Sort(dgw_per1.Columns.Item(1), System.ComponentModel.ListSortDirection.Ascending)
                Dim CONT0 As Integer = (dgw_per1.RowCount - 1)
                Dim i As Integer = 0
                Do While (i <= CONT0)
    ...
    Private Sub txt_doc_per3_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles txt_doc_per3.KeyDown
        If (e.KeyData = Keys.Return) Then
            If (dgw_per3.RowCount = 0) Then
                MessageBox.Show("No existen PERSONAS X PAGAR", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Else
                Me.dgw_per3.Sort(dgw_per3.Columns.Item(2), System.ComponentModel.ListSortDirection.Ascending)
                Dim CONT0 As Integer = (dgw_per3.RowCount - 1)
                Dim i As Integer = 0
                Do While (i <= CONT0)
