Public Class FrmReporteConciliadasCXPCuadre

    Dim obj As New Class1
    Dim MES0, HOJA As String
    Dim REP1 As New FrmConciliadasCXCSincuadreViewer

    Private Shared _instancia As FrmReporteConciliadasCXPCuadre

    Public Shared Function ObtenerInstancia() As FrmReporteConciliadasCXPCuadre
        If _instancia Is Nothing OrElse _instancia.IsDisposed Then
            _instancia = New FrmReporteConciliadasCXPCuadre
        End If
        _instancia.BringToFront()
        Return _instancia
    End Function

    Private Sub FrmReporteConciliadasCXPCuadre_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CargarCuentas()
        CargarAño()
        cbo_año.Text = AÑO
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_pantalla1.Click
        ...
        REP1.CREAR_REPORTE(cbo_mes.Text, txt_cod_cta0.Text, txt_desc_cta0.Text, cbo_año.Text, "CUENTAS POR PAGAR - CUADRE")
        REP1.ShowDialog()
    ...
    Private Sub LlenarDataTable(ByVal mes As String, ByVal statusCon As String, ByVal codPer As String, ByVal statusPer As String, ByVal fechaConcili As Date, ByVal codcuenta As String)
        Try
            ...
            Dim cmd As New SqlCommand("REPORTE_CONCILIADAS_CXP_SIN_CUADRAR", con)
    ...
    Private Sub FrmReporteConciliadasCXPCuadre_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If (e.KeyCode = Keys.Return) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
