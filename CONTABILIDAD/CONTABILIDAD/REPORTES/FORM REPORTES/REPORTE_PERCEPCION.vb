...
Public Class REPORTE_PERCEPCION
#Region "Constructor"
    Private Shared _instancia As REPORTE_PERCEPCION
    Public Shared Function ObtenerInstancia() As REPORTE_PERCEPCION
        If _instancia Is Nothing OrElse _instancia.IsDisposed Then
            _instancia = New REPORTE_PERCEPCION
        End If
