...
Public Class REPORTE_CXC1_COI_BANCO
    Dim COD_CLASE02, STATUS_SUC3, STATUS_SUC2, STATUS_SUC1, STATUS_SUC02, STATUS_PER3, STATUS_PER2, STATUS_PER1, STATUS_DOC3, STATUS_DOC2, STATUS_DOC1, STATUS_DOC02, COD_SUCURSAL3, COD_SUCURSAL2, COD_SUCURSAL1, COD_SUCURSAL02, COD_PER3, COD_PER2, COD_PER1, COD_DOC3, COD_CLASE1, COD_CLASE2, COD_CLASE3, COD_DOC02, COD_DOC1, COD_DOC2 As String
    ...
    Private Sub REPORTE_CXC1_COI_BANCO_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If (e.KeyCode = Keys.Return) Then
            SendKeys.Send("{tab}")
        End If
    End Sub
   Private Sub REPORTE_CXC1_COI_BANCO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        KeyPreview = True
        CARGAR_PERSONAS()
        CARGAR_SUCURSAL()
        CARGAR_AÑOS()
    ...
    Sub CARGAR_DOC_PERMITIDOS()
        Try
            ...
            cmd.Parameters.Add("@TIPO_CTA", SqlDbType.VarChar).Value = "C"
    ...
    End Sub
    Private Sub CH_DOC1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CH_DOC1.CheckedChanged
        If CH_DOC1.Checked Then
    ...
    Private Sub ch_per1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ch_per1.CheckedChanged
        If ch_per1.Checked Then
    ...
    Private Sub ch_si1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ch_si1.CheckedChanged
        If ch_si1.Checked Then
    ...
    Private Sub ch_si1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ch_si1.KeyDown
    ...
    Private Sub btn_archivo1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_archivo1.Click
        If Not Procesando Then
            ...
            DGW2.Rows.Clear()
            Try
                Dim CMD As New SqlCommand("REPORTE_CXC_PTES1", con)
                CMD.CommandType = CommandType.StoredProcedure
