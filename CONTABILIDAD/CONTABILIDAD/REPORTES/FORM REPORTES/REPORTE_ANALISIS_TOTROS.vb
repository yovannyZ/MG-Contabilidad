...
Public Class REPORTE_ANALISIS_TOTROS
    Private MES0, ORDEN, HOJA As String
    Private obj As New Class1
    Private REP1 As New REP_CONCILIADO_OTROS
    Private REP2 As New REP_PENDIENTE_OTROS
    ...
    Private Sub btn_pantalla1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla1.Click
        ...
        ElseIf (cbo_año.SelectedIndex = -1) Then
            ...
            cbo_año.Focus()
        ElseIf (cbo_hoja.SelectedIndex = -1) Then
            MessageBox.Show("Debe elegir el Tipo de Hoja a imprimir", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            cbo_hoja.Focus()
        Else
            ORDEN = "F"
            ORDEN = cbo_orden.Text.Substring(0, 1).ToUpper
            ...
            If ch_p.Checked = False Then
                'REP1.CREAR_REPORTE(cbo_mes.Text, txt_desc_cta0.Text, txt_cod_cta0.Text, cbo_año.Text, MES0, "1", "", "1", FECHA_CONC, ORDEN)
                'REP1.ShowDialog()
                REP1.HOJA = HOJA
                REP1.UBICAR_REPORTE()
                '------------------------
            ...
            Else
                REP2.HOJA = HOJA
                REP2.UBICAR_REPORTE()
                REP2.CREAR_REPORTE(cbo_mes.Text, txt_desc_cta0.Text, txt_cod_cta0.Text, cbo_año.Text, MES0, "0", "", "1", SALDOS_IMPORTE, FECHA_CONC, ORDEN)
                REP2.ShowDialog()
            End If
        End If
    End Sub
  ...
  Sub CUENTAS()
        Try
            ...
            DT = obj.MOSTRAR_CUENTAS_STATUS_TIPO(AÑO, "O")
    ...
    Public Sub New()
        ...
        bwExportar.WorkerSupportsCancellation = False
    ...
    Private Sub ExportarWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs)
        ...
        Try
            ...
            If ch_p.Checked Then
                stCon = 0
                archivoExcel = "AnalisisOtrosPendientes" & txt_cod_cta0.Text
            Else
                stCon = 1
                archivoExcel = "AnalisisOtrosConciliadas" & txt_cod_cta0.Text
            End If
            Dim cmd As New SqlCommand("REPORTE_CONCILIADAS_OTROS", con)
            cmd.CommandType = CommandType.StoredProcedure
            ...
            par5.Value = "" : par6.Value = 1 : par7.Value = FECHA_CONC
