...
Public Class REPORTE_CTA_COMP
    Dim COD_AUX As String
    Dim OBJ As New Class1
    Dim OFR As New REP_CTA_COMP
    Private Sub btn_pantalla1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn_pantalla1.Click
        ...
        If CBO_COMP.SelectedIndex = -1 Then MessageBox.Show("Debe elegir el Comprobante", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation) : CBO_COMP.Focus() : Exit Sub
        ...
        Dim COD_COMP0 As String = OBJ.COD_COMP(CBO_COMP.Text, COD_AUX)
        ...
        OFR.CREAR_REPORTE(COD_AUX, COD_CTA, txt_desc_cta0.Text, MES1, MES2, ORDEN, COD_COMP0)
        OFR.ShowDialog()
    End Sub
    ...
    Private Sub cbo_aux_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cbo_aux.SelectedIndexChanged
        If cbo_aux.SelectedIndex <> -1 Then
            COD_AUX = OBJ.COD_AUX(cbo_aux.Text.ToString)
            CBO_COMPROBANTE()
        End If
    End Sub
    Sub CBO_AUX00()
