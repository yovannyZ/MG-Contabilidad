...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DT_PTE_DOC_CXP"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DT_PTE_DOC_CXP
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DT_PTE_DOC_CXP = CType(MyBase.Clone,DT_PTE_DOC_CXP)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DT_PTE_DOC_CXP"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DT_PTE_DOC_CXP.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DT_PTE_DOC_CXP = New DT_PTE_DOC_CXP
...
Namespace DT_PTE_DOC_CXPTableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     Pctas_Pagar.cod_per, Pctas_Pagar.cod_doc, Pctas_Pagar.nro_doc, Pctas_P"& _ 
                "agar.nro_doc_per, Pctas_Pagar.imp_doc, Pctas_Pagar.imp_ini,                     "& _ 
                "   Pctas_Pagar.cod_d_h, Pctas_Pagar.cod_moneda, Pctas_Pagar.tipo_cambio, Pctas_P"& _ 
                "agar.fecha_doc, Pctas_Pagar.cod_cuenta,                        Pctas_Pagar.fecha"& _ 
                "_ven, Pctas_Pagar.observacion, MAESTRO_PERSONAS.DESC_PER, MAESTRO_PERSONAS.NRO_D"& _ 
                "OC AS NRO_RUC,                           (SELECT     Desc_moneda                "& _ 
                "             FROM          BD_General_Coi.dbo.MONEDA                            "& _ 
                " WHERE      (Cod_moneda = Pctas_Pagar.cod_moneda)) AS DESC_MONEDA FROM         P"& _ 
                "ctas_Pagar INNER JOIN                       MAESTRO_PERSONAS ON Pctas_Pagar.cod_"& _ 
                "per = MAESTRO_PERSONAS.COD_PER WHERE     (@STATUS_DOC = '1') AND (@STATUS_PER = "& _ 
                "'1') AND (Pctas_Pagar.imp_doc > 0) AND (Pctas_Pagar.fecha_doc BETWEEN @FECHA1 AN"& _ 
                "D                        @FECHA2) OR                       (@STATUS_DOC = '0') A"& _ 
                "ND (@STATUS_PER = '1') AND (Pctas_Pagar.imp_doc > 0) AND (Pctas_Pagar.fecha_doc "& _ 
                "BETWEEN @FECHA1 AND                        @FECHA2) AND (Pctas_Pagar.cod_doc = @"& _ 
                "COD_DOC) OR                       (@STATUS_DOC = '1') AND (@STATUS_PER = '0') AN"& _ 
                "D (Pctas_Pagar.imp_doc > 0) AND (Pctas_Pagar.fecha_doc BETWEEN @FECHA1 AND      "& _ 
                "                  @FECHA2) AND (Pctas_Pagar.cod_per = @COD_PER) OR              "& _ 
                "         (@STATUS_DOC = '0') AND (@STATUS_PER = '0') AND (Pctas_Pagar.imp_doc > "& _ 
                "0) AND (Pctas_Pagar.fecha_doc BETWEEN @FECHA1 AND                        @FECHA2"& _ 
                ") AND (Pctas_Pagar.cod_doc = @COD_DOC) AND (Pctas_Pagar.cod_per = @COD_PER)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DT_PTE_DOC_CXP.DataTable1DataTable, ByVal STATUS_DOC As String, ByVal STATUS_PER As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_DOC As String, ByVal COD_PER As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal STATUS_DOC As String, ByVal STATUS_PER As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_DOC As String, ByVal COD_PER As String) As DT_PTE_DOC_CXP.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (STATUS_DOC Is Nothing) Then
                Throw New Global.System.ArgumentNullException("STATUS_DOC")
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(5).Value = CType(COD_PER,String)
            End If
            Dim dataTable As DT_PTE_DOC_CXP.DataTable1DataTable = New DT_PTE_DOC_CXP.DataTable1DataTable
