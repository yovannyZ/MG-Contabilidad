...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DT_CANC_CXP"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DT_CANC_CXP
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DT_CANC_CXP = CType(MyBase.Clone,DT_CANC_CXP)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DT_CANC_CXP"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DT_CANC_CXP.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DT_CANC_CXP = New DT_CANC_CXP
...
Namespace DT_CANC_CXPTableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     I.cod_mp, I.nro_mp, I.cod_banco, I.fecha_mp, I.desc_ope, I.cod_moneda,"& _ 
                ...
                "d_banco = BAN.Cod_Banco WHERE     (I.tipo_operacion = 'E') AND (I.fecha_mp BETWE"& _ 
                "EN @FECHA1 AND @FECHA2) AND (@STATUS_PER = '1') AND (@STATUS_DOC = '1') OR      "& _ 
                "                 (I.tipo_operacion = 'E') AND (I.fecha_mp BETWEEN @FECHA1 AND @F"& _ 
                "ECHA2) AND (@STATUS_PER = '0') AND (@STATUS_DOC = '1') AND                      "& _ 
                "  (T.cod_per = @COD_PER) OR                       (I.tipo_operacion = 'E') AND ("& _ 
                "I.fecha_mp BETWEEN @FECHA1 AND @FECHA2) AND (@STATUS_PER = '1') AND (@STATUS_DOC"& _ 
                " = '0') AND                        (T.cod_doc = @COD_DOC) OR                    "& _ 
                "   (I.tipo_operacion = 'E') AND (I.fecha_mp BETWEEN @FECHA1 AND @FECHA2) AND (@S"& _ 
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DT_CANC_CXP.DataTable1DataTable, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal STATUS_PER As String, ByVal STATUS_DOC As String, ByVal COD_PER As String, ByVal COD_DOC As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal STATUS_PER As String, ByVal STATUS_DOC As String, ByVal COD_PER As String, ByVal COD_DOC As String) As DT_CANC_CXP.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (FECHA1.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(FECHA1.Value,Date)
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(5).Value = CType(COD_DOC,String)
            End If
            Dim dataTable As DT_CANC_CXP.DataTable1DataTable = New DT_CANC_CXP.DataTable1DataTable
