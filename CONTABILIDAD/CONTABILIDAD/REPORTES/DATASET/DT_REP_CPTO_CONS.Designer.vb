...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DT_REP_CPTO_CONS"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DT_REP_CPTO_CONS
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DT_REP_CPTO_CONS = CType(MyBase.Clone,DT_REP_CPTO_CONS)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DT_REP_CPTO_CONS"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DT_REP_CPTO_CONS.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DT_REP_CPTO_CONS = New DT_REP_CPTO_CONS
    ...
    Partial Public Class DataTable1DataTable
        ...
        Public Overloads Function AddDataTable1Row( _
            ...
            Dim columnValuesArray() As Object = New Object() {COD_MP, NRO_MP, COD_BANCO, FECHA_MP, COD_AUX, COD_COMP, ITEM, COD_DOC, NRO_DOC, FECHA_DOC, COD_CPTO, COD_CUENTA, GLOSA, IMP_DOC, COD_D_H, COD_MONEDA, COD_CC, STATUS_TRANS, DESC_CPTO, TIPO_OPERACION, IMPORTE, NRO_COMP, DESC_BANCO, COD_PER, DESC_PER}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function FindByCOD_MPNRO_MPCOD_BANCOITEM(ByVal COD_MP As String, ByVal NRO_MP As String, ByVal COD_BANCO As String, ByVal ITEM As String) As DataTable1Row
            Return CType(Me.Rows.Find(New Object() {COD_MP, NRO_MP, COD_BANCO, ITEM}),DataTable1Row)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnCOD_MP, Me.columnNRO_MP, Me.columnCOD_BANCO, Me.columnITEM}, true))
...
Namespace DT_REP_CPTO_CONSTableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT    "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"DISTINCT"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  I.COD_MP, I.NRO_MP, I.COD_BANCO, I.FECHA_MP,  I.COD_AUX, "& _ 
                "I.COD_COMP, T.ITEM, T.COD_DOC,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  T.NRO_DOC, T.FECHA_DOC, T.COD_CPTO, T.COD_CUEN"& _ 
                "TA, T.GLOSA,  T.IMP_DOC, T.COD_D_H, T.COD_MONEDA,  T.COD_CC, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  T.STATUS_TRANS,"& _ 
                "  MAESTRO_CONCEPTOS.DESC_CPTO, I.TIPO_OPERACION, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   CASE WHEN I.COD_D_H = 'H' "& _ 
                "THEN (T .IMP_DOC * (- 1)) ELSE T .IMP_DOC END AS IMPORTE,  I.NRO_COMP, H.DESC_BA"& _ 
                "NCO ,T.COD_PER,Z.DESC_PER"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   FROM          I_BANCO AS I "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   INNER JOIN T_BANCO"& _ 
                " AS T ON I.COD_MP = T.COD_MP AND  I.NRO_MP = T.NRO_MP AND I.COD_BANCO = T.COD_BA"& _ 
                "NCO "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   INNER JOIN MAESTRO_CONCEPTOS ON T.COD_CPTO = MAESTRO_CONCEPTOS.COD_CPTO"& _ 
                "  "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   INNER JOIN MAESTRO_BANCOS H ON I.COD_BANCO=H.COD_BANCO "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   LEFT JOIN MAE"& _ 
                "STRO_PERSONAS Z ON T.COD_PER=Z.COD_PER"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   WHERE  "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    T.COD_MONEDA=@COD_MONEDA"& _ 
                " AND I.FECHA_MP BETWEEN @FECHA1 AND @FECHA2 AND (ISNULL(I.STATUS_EXT,'0')='0') A"& _ 
                "ND T.COD_CPTO=@COD_CPTO  "
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DT_REP_CPTO_CONS.DataTable1DataTable, ByVal COD_MONEDA As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_CPTO As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal COD_MONEDA As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_CPTO As String) As DT_REP_CPTO_CONS.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (COD_MONEDA Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(3).Value = CType(COD_CPTO,String)
            End If
            Dim dataTable As DT_REP_CPTO_CONS.DataTable1DataTable = New DT_REP_CPTO_CONS.DataTable1DataTable
