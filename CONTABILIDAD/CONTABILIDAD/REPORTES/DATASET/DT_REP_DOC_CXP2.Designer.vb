...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DT_REP_DOC_CXP2"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DT_REP_DOC_CXP2
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DT_REP_DOC_CXP2 = CType(MyBase.Clone,DT_REP_DOC_CXP2)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DT_REP_DOC_CXP2"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DT_REP_DOC_CXP2.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DT_REP_DOC_CXP2 = New DT_REP_DOC_CXP2
...
Namespace DT_REP_DOC_CXP2TableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     PTE.cod_per, PTE.cod_doc, PTE.nro_doc, PTE.nro_doc_per, PTE.imp_doc, P"& _ 
                "TE.imp_ini, PTE.cod_d_h, PTE.cod_moneda, PTE.tipo_cambio,                       "& _ 
                " PTE.fecha_doc, PTE.cod_cuenta, PTE.fecha_ven, PTE.observacion, MAESTRO_PERSONAS"& _ 
                ".DESC_PER, MAESTRO_PERSONAS.NRO_DOC AS NRO_RUC,                           (SELEC"& _ 
                "T     Desc_moneda                             FROM          BD_General_Coi.dbo.M"& _ 
                "ONEDA                             WHERE      (Cod_moneda = PTE.cod_moneda)) AS D"& _ 
                "ESC_MONEDA FROM         Pctas_Pagar AS PTE INNER JOIN                       MAES"& _ 
                "TRO_PERSONAS ON PTE.cod_per = MAESTRO_PERSONAS.COD_PER WHERE     (@STATUS_DOC = "& _ 
                "'1') AND (@STATUS_PER = '1') AND (PTE.imp_doc > 0) AND (PTE.fecha_ven BETWEEN @F"& _ 
                "ECHA1 AND @FECHA2) OR                       (@STATUS_DOC = '0') AND (@STATUS_PER"& _ 
                " = '1') AND (PTE.imp_doc > 0) AND (PTE.fecha_ven BETWEEN @FECHA1 AND @FECHA2) AN"& _ 
                "D                        (PTE.cod_doc = @COD_DOC) OR                       (@STA"& _ 
                "TUS_DOC = '1') AND (@STATUS_PER = '0') AND (PTE.imp_doc > 0) AND (PTE.fecha_ven "& _ 
                "BETWEEN @FECHA1 AND @FECHA2) AND                        (PTE.cod_per = @COD_PER)"& _ 
                " OR                       (@STATUS_DOC = '0') AND (@STATUS_PER = '0') AND (PTE.i"& _ 
                "mp_doc > 0) AND (PTE.fecha_ven BETWEEN @FECHA1 AND @FECHA2) AND                 "& _ 
                "       (PTE.cod_doc = @COD_DOC) AND (PTE.cod_per = @COD_PER)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DT_REP_DOC_CXP2.DataTable1DataTable, ByVal STATUS_DOC As String, ByVal STATUS_PER As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_DOC As String, ByVal COD_PER As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal STATUS_DOC As String, ByVal STATUS_PER As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_DOC As String, ByVal COD_PER As String) As DT_REP_DOC_CXP2.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (STATUS_DOC Is Nothing) Then
                Throw New Global.System.ArgumentNullException("STATUS_DOC")
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(5).Value = CType(COD_PER,String)
            End If
            Dim dataTable As DT_REP_DOC_CXP2.DataTable1DataTable = New DT_REP_DOC_CXP2.DataTable1DataTable
