...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DT_PTE_DOC_CXC"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DT_PTE_DOC_CXC
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DT_PTE_DOC_CXC = CType(MyBase.Clone,DT_PTE_DOC_CXC)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DT_PTE_DOC_CXC"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DT_PTE_DOC_CXC.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DT_PTE_DOC_CXC = New DT_PTE_DOC_CXC
...
Namespace DT_PTE_DOC_CXCTableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     PCtas_Cobrar.cod_per, PCtas_Cobrar.cod_doc, PCtas_Cobrar.nro_doc, PCta"& _ 
                ...
                "PCtas_Cobrar.fecha_doc BETWEEN @FECHA1 AND                        @FECHA2) OR   "& _ 
                "                    (PCtas_Cobrar.imp_doc > 0) AND (@STATUS_DOC = '0') AND (@STA"& _ 
                "TUS_PER = '1') AND (PCtas_Cobrar.fecha_doc BETWEEN @FECHA1 AND                  "& _ 
                "      @FECHA2) AND (PCtas_Cobrar.cod_doc = @COD_DOC) OR                       (P"& _ 
                "Ctas_Cobrar.imp_doc > 0) AND (@STATUS_DOC = '1') AND (@STATUS_PER = '0') AND (PC"& _ 
                "tas_Cobrar.fecha_doc BETWEEN @FECHA1 AND                        @FECHA2) AND (PC"& _ 
                "tas_Cobrar.cod_per = @COD_PER) OR                       (PCtas_Cobrar.imp_doc > "& _ 
                "0) AND (@STATUS_DOC = '0') AND (@STATUS_PER = '0') AND (PCtas_Cobrar.fecha_doc B"& _ 
                "ETWEEN @FECHA1 AND                        @FECHA2) AND (PCtas_Cobrar.cod_doc = @"& _ 
                "COD_DOC) AND (PCtas_Cobrar.cod_per = @COD_PER)"
            ...
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@FECHA1", Global.System.Data.SqlDbType.DateTime, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "FECHA_DOC", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@FECHA2", Global.System.Data.SqlDbType.DateTime, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "FECHA_DOC", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DT_PTE_DOC_CXC.DataTable1DataTable, ByVal STATUS_DOC As String, ByVal STATUS_PER As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_DOC As String, ByVal COD_PER As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal STATUS_DOC As String, ByVal STATUS_PER As String, ByVal FECHA1 As Global.System.Nullable(Of Date), ByVal FECHA2 As Global.System.Nullable(Of Date), ByVal COD_DOC As String, ByVal COD_PER As String) As DT_PTE_DOC_CXC.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (STATUS_DOC Is Nothing) Then
                Throw New Global.System.ArgumentNullException("STATUS_DOC")
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(5).Value = CType(COD_PER,String)
            End If
            Dim dataTable As DT_PTE_DOC_CXC.DataTable1DataTable = New DT_PTE_DOC_CXC.DataTable1DataTable
