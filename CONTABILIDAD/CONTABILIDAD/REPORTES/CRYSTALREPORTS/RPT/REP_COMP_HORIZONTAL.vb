...
Public Class REP_COMP_HORIZONTAL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "REP_COMP_HORIZONTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedREP_COMP_HORIZONTAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REP_COMP_HORIZONTAL = New REP_COMP_HORIZONTAL
        rpt.Site = Me.Site
        Return rpt
    End Function
