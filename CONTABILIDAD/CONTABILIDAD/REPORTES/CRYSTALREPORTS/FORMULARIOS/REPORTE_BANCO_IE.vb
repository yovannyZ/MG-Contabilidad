...
Public Class REPORTE_BANCO_IE
    Dim OBJ As New Class1
    Public N, M, E1, C, P As Boolean
    Dim fila2, fila1 As Integer
    Dim CON_COI As New SqlConnection
    Dim CUENTA_IGV, CUENTA_TOTAL, mes5, mes6 As String
    Dim COD_AUX, COD_COMP, TITULO As String
    Dim repor As New CrystalReport2
    Dim REPOR2 As New BANCO_HOR
    Dim I_E As New REP_BANCO_CON
    Dim I_E_HOR As New REP_BANCO_HOR
    ...
    Sub CARGAR_COMPROBANTES_CABECERA()
        Try
            Dim CMD As New SqlCommand("REPORTE_MOSTRAR_I_BANCO", con)
            ...
            'dgw1.Columns(7).DefaultCellStyle.Alignment = DataGridViewContentAlignment.BottomRight
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
        ...
        For I = 0 To cont
            If dgw1.Item(13, I).Value = True Then
                Try
                    ...
                    Dim PROG_01 As New SqlCommand("REPORTE_MOSTRAR_T_BANCO", con)
                    ...
                    While Rs3.Read
                        Dim DH, TIPO_OPE As String
                        DH = Rs3.GetValue(7)
                        TIPO_OPE = Rs3.GetValue(18)
                        Dim IMP_PAGAR, NUEVO_IMPORTE As Decimal
                        ...
                        If TIPO_OPE = "I" Then
                            ...
                            End If
                            If DH = "H" Then NUEVO_IMPORTE = IMP_PAGAR Else NUEVO_IMPORTE = IMP_PAGAR * -1
                        End If
                        If TIPO_OPE = "E" Then
                            If MON_CAB <> MON_DET Then
                                If MON_CAB = "D" Then
                            ...
                            Else
                                IMP_PAGAR = Rs3.GetValue(14)
                            End If
                            If DH = "D" Then NUEVO_IMPORTE = IMP_PAGAR Else NUEVO_IMPORTE = IMP_PAGAR * -1
                        End If
                        '-----------------------------------------------------------------------------------
                        dt.DataTable1.Rows.Add((Rs3.GetValue(6).ToString.Substring(0, 10)),Rs3.GetValue(5), Rs3.GetValue(3), Rs3.GetValue(1), (Rs3.GetValue(0)),Rs3.GetValue(8), Rs3.GetValue(4), Rs3.GetValue(20), Rs3.GetValue(11), Rs3.GetValue(14), NUEVO_IMPORTE, Rs3.GetValue(15),Rs3.GetValue(16),Rs3.GetValue(17),Rs3.GetValue(13), Rs3.GetValue(25), Rs3.GetValue(10), Rs3.GetValue(21), Rs3.GetValue(22), Rs3.GetValue(23), Rs3.GetValue(24), Rs3.GetValue(21))
            ...
            If dgw1.Item(13, I).Value = True Then
                Try
                    ...
                    While Rs3.Read
                        ...
                        End If
                        '-----------------------------------------------------------------------------------
                        dt.DataTable1.Rows.Add((Rs3.GetValue(6).ToString.Substring(0, 10)),Rs3.GetValue(5), Rs3.GetValue(3), Rs3.GetValue(1), (Rs3.GetValue(0)),Rs3.GetValue(8),Rs3.GetValue(4),Rs3.GetValue(20), Rs3.GetValue(11),Rs3.GetValue(14),NUEVO_IMPORTE, Rs3.GetValue(15),Rs3.GetValue(16),Rs3.GetValue(17),Rs3.GetValue(13), Rs3.GetValue(25), Rs3.GetValue(10),Rs3.GetValue(21),Rs3.GetValue(22),Rs3.GetValue(23), Rs3.GetValue(24), Rs3.GetValue(7))
                        'dt.DataTable1.Rows.Add(Rs3.GetValue(6).ToString.Substring(0, 10), Rs3.GetValue(5), Rs3.GetValue(3), Rs3.GetValue(1), (Rs3.GetValue(0)), Rs3.GetValue(8), Rs3.GetValue(4), Rs3.GetValue(20), Rs3.GetValue(11), Rs3.GetValue(19), Rs3.GetValue(14), Rs3.GetValue(15), Rs3.GetValue(16), Rs3.GetValue(17), Rs3.GetValue(13), Rs3.GetValue(18), Rs3.GetValue(10), Rs3.GetValue(21), Rs3.GetValue(22), Rs3.GetValue(23), Rs3.GetValue(24))
                    End While
                    con.Close()
                Catch ex As Exception
