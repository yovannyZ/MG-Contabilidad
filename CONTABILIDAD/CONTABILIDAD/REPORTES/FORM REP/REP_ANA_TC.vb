...
Public Class REP_ANA_TC

    Private Sub REP_ANA_TC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub CREAR_REPORTE(ByVal TITULO As String)
        ...
        Dim DES_RUTA As String = (aa & "\REPORTES\" & "REP_ANA_TC.rdlc")
