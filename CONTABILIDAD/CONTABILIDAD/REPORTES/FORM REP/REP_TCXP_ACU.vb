...
Public Class REP_TCXP_ACU
    ...
    End Sub
    Public Sub CREAR_REPORTE(ByVal DES_MES As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal AÑO0 As String, ByVal COD_MES2 As String, ByVal COD_PER As String)
        ...
        Me.REPORTE_TCXP_KARDEX_ACUMULADOTableAdapter.Fill(Me.DT_REP_ANA_CXP.REPORTE_TCXP_KARDEX_ACUMULADO, AÑO0, COD_MES2, COD_CTA, COD_PER)
    End Sub
