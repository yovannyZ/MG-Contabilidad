...
Public Class REP_CONC
    ...
    End Sub
    Sub CREAR_REPORTE(ByVal AÑO00 As String, ByVal MES00 As String, ByVal COD_MES As String, ByVal COD_BANCO As String, ByVal DEBE As Decimal, ByVal HABER As Decimal, ByVal DESC_BANCO As String, ByVal FECHA_CONC As Date)
        ...
        Me.REPORTE_BANCO_CONC_PTE2TableAdapter.Fill(Me.DT_CONC_PTE.REPORTE_BANCO_CONC_PTE2, COD_BANCO, AÑO00, COD_MES, "1", FECHA_CONC)
    End Sub
End Class