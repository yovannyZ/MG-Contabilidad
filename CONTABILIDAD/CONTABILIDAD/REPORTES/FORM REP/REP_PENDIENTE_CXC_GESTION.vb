...
Public Class REP_PENDIENTE_CXC_GESTION
    Private Sub REP_PENDIENTE_CXC_GESTION_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub CREAR_REPORTE(ByVal DES_MES As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal AÑO0 As String, ByVal COD_MES As String, ByVal S_CONCILIADO As String, ByVal COD_PER As String, ByVal S_PER As String, ByVal FECHA_CONC As DateTime)
        ...
        Me.REPORTE_CONCILIADAS_CXCTableAdapter.Fill(DT_REP_ANA_CXC.REPORTE_CONCILIADAS_CXC, AÑO0, COD_MES, COD_CTA, S_CONCILIADO, COD_PER, S_PER, FECHA_CONC)
    End Sub
End Class