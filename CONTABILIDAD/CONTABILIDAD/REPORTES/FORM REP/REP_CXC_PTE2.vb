...
Public Class REP_CXC_PTE2

    Private Sub REP_CXC_PTE2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub CREAR_REPORTE(ByVal COD_SUC As String, ByVal ST_SUC As String, ByVal FECHA1 As DateTime, ByVal FECHA2 As DateTime, ByVal ST_PER As String, ByVal COD_PER As String, ByVal ST_DOC As String, ByVal COD_DOC As String, ByVal ST_CTA As String, ByVal COD_CTA As String)
        ...
        Me.REPORTE_CXC_PTES2TableAdapter.Connection = con
        Me.REPORTE_CXC_PTES2TableAdapter.CommandTimeout = 0
        Me.REPORTE_CXC_PTES2TableAdapter.Fill(Me.DT_REPORTES.REPORTE_CXC_PTES2, COD_SUC, ST_SUC, FECHA1, FECHA2, ST_PER, COD_PER, ST_DOC, COD_DOC, ST_CTA, COD_CTA)
    End Sub
