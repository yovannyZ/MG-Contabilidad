...
Public Class REP_PENDIENTE_CXC_ACTUALIZADO
    Public HOJA As String
    Private Sub REP_PENDIENTE_CXC_ACTUALIZADO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Public Sub CrearReporte(ByVal DES_MES As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal AÑO0 As String, ByVal COD_MES As String, ByVal S_CONCILIADO As String, ByVal COD_PER As String, ByVal S_PER As String, ByVal SALDOS As Decimal, ByVal FECHA_CONC As DateTime, ByVal VISIBLE_MOV As String, ByVal VISIBLE_MAESTRO As String)
        ...
        Select Case HOJA
            Case "01"
                ...
                'REPORTE_CONCILIADAS_CXC_ACTUALIZADATableAdapter.Connection = con
                'REPORTE_CONCILIADAS_CXC_ACTUALIZADATableAdapter.Fill(DT_REP_ANA_CXC.REPORTE_CONCILIADAS_CXC_ACTUALIZADA, AÑO0, COD_MES, COD_CTA, S_CONCILIADO, COD_PER, S_PER, FECHA_CONC)
            Case "02"
    ...
    Public Sub LimpiarDt()
        DT_REP_ANA_CXC.REPORTE_ACTUALIZADO.Clear()
    End Sub
    Public Sub LlenarDt(ByVal COD_MONEDA As String, ByVal DESC_MONEDA As String, ByVal FECHA_COMP As DateTime, ByVal COD_AUX As String, ByVal COD_COMP As String, _
        ...
        DT_REP_ANA_CXC.REPORTE_ACTUALIZADO.Rows.Add(COD_MONEDA, DESC_MONEDA, FECHA_COMP, COD_AUX, COD_COMP, _
