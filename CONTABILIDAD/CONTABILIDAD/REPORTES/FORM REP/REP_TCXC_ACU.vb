...
Public Class REP_TCXC_ACU

    Private Sub REP_TCXC_ACU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub CREAR_REPORTE(ByVal DES_MES As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal AÑO0 As String, ByVal COD_MES As String, ByVal COD_PER As String)
        ...
        Me.REPORTE_TCXC_KARDEX_ACUMULADOTableAdapter.Connection = con
        Me.REPORTE_TCXC_KARDEX_ACUMULADOTableAdapter.Fill(Me.DT_REP_ANA_CXC.REPORTE_TCXC_KARDEX_ACUMULADO, AÑO0, COD_MES, COD_CTA, COD_PER)
    End Sub
