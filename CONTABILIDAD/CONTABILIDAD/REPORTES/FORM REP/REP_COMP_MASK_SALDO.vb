...
Public Class REP_COMP_MASK_SALDO

    Private Sub REP_COMP_MASK_SALDO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Sub CREAR_REPORTE(ByVal MES1 As String, ByVal FECHA As DateTime, ByVal MASK As String, ByVal MES2 As String)
