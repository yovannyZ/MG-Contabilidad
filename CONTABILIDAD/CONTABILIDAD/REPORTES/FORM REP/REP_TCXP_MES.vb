...
Public Class REP_TCXP_MES

    Private Sub REP_TCXP_MES_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub CREAR_REPORTE(ByVal DES_MES As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal AÑO0 As String, ByVal COD_MES As String, ByVal COD_PER As String)
        ...
        Me.REPORTE_TCXP_KARDEX_NO_ACUMULADOTableAdapter.Connection = con
        Me.REPORTE_TCXP_KARDEX_NO_ACUMULADOTableAdapter.Fill(Me.DT_REP_ANA_CXP.REPORTE_TCXP_KARDEX_NO_ACUMULADO, AÑO0, COD_MES, COD_CTA, COD_PER)
    End Sub
