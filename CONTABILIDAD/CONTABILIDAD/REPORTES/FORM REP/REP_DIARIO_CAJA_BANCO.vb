...
Public Class REP_DIARIO_CAJA_BANCO
    Public HOJA As String
    Private Sub REP_DIARIO_CAJA_BANCO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Select Case HOJA
            Case "01"
    ...
    Public Sub CREAR_REPORTE(ByVal EMISION As DateTime, ByVal COD_MES As String, ByVal DESC_MES As String, _
        ...
        Select Case HOJA
            Case "01"
                Me.ReportViewer1.LocalReport.SetParameters(parametros)
                Me.REPORTE_DIARIO_CAJA_BANCOTableAdapter.Connection = con 
                Me.REPORTE_DIARIO_CAJA_BANCOTableAdapter.Fill(Me.DT_REPORTE_DIARIO_CAJA_BANCO.REPORTE_DIARIO_CAJA_BANCO, AÑO, COD_MES, COD_AUX, STATUS_AUX)
                'Case "02"
    ...
    'Private Sub REP_DIARIO_CAJA_BANCO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    '    'TODO: esta línea de código carga datos en la tabla 'DT_REPORTE_DIARIO_CAJA_BANCO.REPORTE_DIARIO_CAJA_BANCO' Puede moverla o quitarla según sea necesario.
    '    Me.REPORTE_DIARIO_CAJA_BANCOTableAdapter.Fill(Me.DT_REPORTE_DIARIO_CAJA_BANCO.REPORTE_DIARIO_CAJA_BANCO)
