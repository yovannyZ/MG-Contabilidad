...
Public Class REP_CC_SALDO
    Private Sub REP_CC_SALDO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       Me.ReportViewer1.SetDisplayMode(DisplayMode.PrintLayout)
        Me.ReportViewer1.ZoomMode = ZoomMode.PageWidth
        Me.ReportViewer1.Refresh()
        Me.ReportViewer1.RefreshReport()
    End Sub
    Sub CREAR_REPORTE(ByVal MES_AL As String, ByVal COD_CC As String, ByVal ST_CC As String, ByVal COD_MONEDA As String, ByVal P1 As Integer, ByVal P2 As Integer, ByVal P3 As Integer, ByVal P4 As Integer, ByVal P5 As Integer, ByVal P6 As Integer, ByVal P7 As Integer, ByVal P8 As Integer, ByVal P9 As Integer, ByVal P10 As Integer, ByVal P11 As Integer, ByVal P12 As Integer, ByVal DES_MONEDA As String)
        ...
        'Me.REPORTE_CC_SALDOTableAdapter.Connection = con
        'Me.REPORTE_CC_SALDOTableAdapter.Fill(Me.DT_CC_T_CON.REPORTE_CC_SALDO2, ST_CC, COD_CC, COD_MONEDA, AÑO)
    End Sub
    Sub LIMPIAR()
        DT_CC_T_CON.REPORTE_CC_SALDO2.Clear()
    End Sub
    ...
    Sub llenar_dt(ByVal COD_CC As String, ByVal DES_AREA As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal C1 As Decimal, ByVal C2 As Decimal, ByVal C3 As Decimal, ByVal C4 As Decimal, ByVal C5 As Decimal, ByVal C6 As Decimal, ByVal C7 As Decimal, ByVal C8 As Decimal, ByVal C9 As Decimal, ByVal C10 As Decimal, ByVal C11 As Decimal, ByVal C12 As Decimal, ByVal TOTAL As Decimal)
        DT_CC_T_CON.REPORTE_CC_SALDO2.Rows.Add(COD_CC, DES_AREA, DES_CTA, COD_CTA, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, TOTAL)
    End Sub
End Class