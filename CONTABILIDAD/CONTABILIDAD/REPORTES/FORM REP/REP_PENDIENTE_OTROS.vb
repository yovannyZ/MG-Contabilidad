...
Public Class REP_PENDIENTE_OTROS
    Public HOJA As String
    Private Sub REP_PENDIENTE_OTROS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Select Case HOJA
            Case "01"
    ...
    End Sub
    Sub CREAR_REPORTE(ByVal DES_MES As String, ByVal DES_CTA As String, ByVal COD_CTA As String, ByVal AÑO0 As String, ByVal COD_MES As String, ByVal S_CONCILIADO As String, ByVal COD_PER As String, ByVal S_PER As String, ByVal SALDOS As Decimal, ByVal FECHA_CONC As DateTime, ByVal ORDEN As String)
