...
Public Class REP_CXC_PTE4

    Private Sub REP_CXC_PTE4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub parametros(ByVal cod_sucursal As String, ByVal cod_per As String, ByVal status_suc As String, ByVal status_per As String, ByVal fecha1 As DateTime, ByVal fecha2 As DateTime, ByVal STATUS_DOC As String, ByVal COD_DOC As String, ByVal DIAS As Integer, ByVal BLOQUES As Integer, ByVal DEL_1 As DateTime, ByVal ST_CTA As String, ByVal COD_CTA As String)
        fecha2 = fecha2.Date.AddDays(1)
        Me.REPORTE_CXC_PTES3TableAdapter.Connection = con
        Me.REPORTE_CXC_PTES3TableAdapter.Fill(Me.DT_REPORTES.REPORTE_CXC_PTES3, cod_sucursal, status_suc, fecha1, fecha2, status_per, cod_per, STATUS_DOC, COD_DOC, ST_CTA, COD_CTA)
        Dim I As Integer = 0
