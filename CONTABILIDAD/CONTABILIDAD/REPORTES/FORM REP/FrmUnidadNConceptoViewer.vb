...
Public Class FrmUnidadNConceptoViewer

    Private Sub FrmUnidadNConceptoViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub CREAR_REPORTE(ByVal EMPRESA As String, ByVal MES As String, ByVal OPCION As String, ByVal año As String)
    ...
    Sub LIMPIAR()
        DsUnidadNegocioConcepto.Dt_1.Clear()
    End Sub
    Public Sub llenar_dt(ByVal p1 As String, ByVal p2 As String, ByVal p3 As String, ByVal p4 As String, ByVal p5 As String, ByVal p6 As Decimal, ByVal p7 As Decimal, ByVal p8 As Decimal, _
    ByVal p9 As Decimal, ByVal p10 As Decimal, ByVal p11 As Decimal, ByVal p12 As Decimal, ByVal p13 As Decimal, ByVal p14 As Decimal, ByVal p15 As Decimal, ByVal p16 As Decimal, _
    ByVal p17 As Decimal, ByVal p18 As Decimal, ByVal p19 As Decimal, ByVal p20 As Decimal, ByVal p21 As Decimal, ByVal p22 As Decimal, ByVal p23 As Decimal, ByVal p24 As Decimal, ByVal p25 As Decimal)

        DsUnidadNegocioConcepto.Dt_1.Rows.Add(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25)
